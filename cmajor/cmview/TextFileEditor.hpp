...
#ifndef CMAJOR_VIEW_TEXT_FILE_EDITOR_INCLUDED
#define CMAJOR_VIEW_TEXT_FILE_EDITOR_INCLUDED
#include <cmajor/cmview/Editor.hpp>

namespace cmajor { namespace view {

struct CMVIEW_API TextFileEditorCreateParams
{
...
class CMVIEW_API TextFileEditor : public Editor
{
public:
...
#endif // CMAJOR_VIEW_TEXT_FILE_EDITOR_INCLUDED
