...
SolutionSettings::SolutionSettings()
     : objectId(boost::uuids::nil_uuid()), container(nullptr), callStackOpen(), localsViewOpen(), openFiles(), currentOpenFile(), currentCursorLine(), breakpoints(), expandedProjects(), dataPtr(nullptr)
{
}
