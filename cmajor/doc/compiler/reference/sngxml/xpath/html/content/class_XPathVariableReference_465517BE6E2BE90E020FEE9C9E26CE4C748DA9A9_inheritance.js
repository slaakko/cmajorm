...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathVariableReference", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathVariableReference_465517BE6E2BE90E020FEE9C9E26CE4C748DA9A9.html" }];
    drawDiagram(classes);
}
