...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathNumberFunction", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathNumberFunction_CE6CD90641D01FDE2F153231C0CBBF4A604055CF.html" }];
    drawDiagram(classes);
}
