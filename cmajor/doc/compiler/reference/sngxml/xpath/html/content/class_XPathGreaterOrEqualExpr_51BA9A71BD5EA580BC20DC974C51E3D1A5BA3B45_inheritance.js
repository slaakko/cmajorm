...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathGreaterOrEqualExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathGreaterOrEqualExpr_51BA9A71BD5EA580BC20DC974C51E3D1A5BA3B45.html" }];
    drawDiagram(classes);
}
