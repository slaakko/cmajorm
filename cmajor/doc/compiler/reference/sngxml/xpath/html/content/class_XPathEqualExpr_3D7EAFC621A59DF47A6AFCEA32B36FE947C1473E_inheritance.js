...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathEqualExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathEqualExpr_3D7EAFC621A59DF47A6AFCEA32B36FE947C1473E.html" }];
    drawDiagram(classes);
}
