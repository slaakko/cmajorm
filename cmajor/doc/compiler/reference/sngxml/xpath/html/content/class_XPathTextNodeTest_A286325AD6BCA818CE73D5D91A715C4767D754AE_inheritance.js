...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathTextNodeTest", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathTextNodeTest_A286325AD6BCA818CE73D5D91A715C4767D754AE.html" }];
    drawDiagram(classes);
}
