...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathLocationStepExpr", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathLocationStepExpr_341DB854A0B8E113DDF0AAB61BC0FED5D1340699.html" }];
    drawDiagram(classes);
}
