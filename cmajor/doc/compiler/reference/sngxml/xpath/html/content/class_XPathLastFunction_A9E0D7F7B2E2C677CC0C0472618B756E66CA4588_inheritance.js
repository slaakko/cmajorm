...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathLastFunction", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathLastFunction_A9E0D7F7B2E2C677CC0C0472618B756E66CA4588.html" }];
    drawDiagram(classes);
}
