...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathNumber", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathNumber_D99BEBB5FEBC4056A70E2B3C31ED48D11FD84AE3.html" }];
    drawDiagram(classes);
}
