...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathNameTest", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathNameTest_9FE6966801C2F179BBED9874ED3B1F97A511206B.html" }];
    drawDiagram(classes);
}
