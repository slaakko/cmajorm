...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathBooleanFunction", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathBooleanFunction_B90F79DC36806A71AD58BE661B736B2C5A76C243.html" }];
    drawDiagram(classes);
}
