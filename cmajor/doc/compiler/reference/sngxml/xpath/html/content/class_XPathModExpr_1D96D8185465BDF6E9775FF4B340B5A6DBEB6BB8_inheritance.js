...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathModExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathModExpr_1D96D8185465BDF6E9775FF4B340B5A6DBEB6BB8.html" }];
    drawDiagram(classes);
}
