...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathAddExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathAddExpr_F6E8231C044C5E80695B5FA94A11048BF7BE5ACE.html" }];
    drawDiagram(classes);
}
