...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathLessExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathLessExpr_20CA4FBE625C11E92A56154772845A99E9EC8AF6.html" }];
    drawDiagram(classes);
}
