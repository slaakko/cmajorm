...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathPrefixTest", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathPrefixTest_27A3766FA5BB8CF74796443EAEB0D3689CDF4B69.html" }];
    drawDiagram(classes);
}
