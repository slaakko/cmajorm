...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathDivExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathDivExpr_6C73B1693359869227BFAADABDEC1A2BE75755E0.html" }];
    drawDiagram(classes);
}
