...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathSubExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathSubExpr_1BD059C3AAA2C6BEA4780429337E0508797CDCDE.html" }];
    drawDiagram(classes);
}
