...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathFilterExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathFilterExpr_98FD491A1F300907213439997EF0BC55E9930D5F.html" }];
    drawDiagram(classes);
}
