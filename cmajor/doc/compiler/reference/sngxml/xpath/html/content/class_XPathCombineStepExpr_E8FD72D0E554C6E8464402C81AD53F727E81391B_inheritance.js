...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathCombineStepExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathCombineStepExpr_E8FD72D0E554C6E8464402C81AD53F727E81391B.html" }];
    drawDiagram(classes);
}
