...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathLessOrEqualExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathLessOrEqualExpr_C6064C8E35EE98F46ACEC304A33B17196EC2F7FC.html" }];
    drawDiagram(classes);
}
