...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathNumberExpr", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathNumberExpr_60DA56E701CDB51FDEB2D506E8A0323C99D55B7E.html" }];
    drawDiagram(classes);
}
