...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathUnionExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathUnionExpr_2A04493AA1B005E2CACB3299D7BF678F997CAD8E.html" }];
    drawDiagram(classes);
}
