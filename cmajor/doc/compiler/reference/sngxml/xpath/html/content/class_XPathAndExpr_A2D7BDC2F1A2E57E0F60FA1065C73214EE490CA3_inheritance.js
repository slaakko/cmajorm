...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathAndExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathAndExpr_A2D7BDC2F1A2E57E0F60FA1065C73214EE490CA3.html" }];
    drawDiagram(classes);
}
