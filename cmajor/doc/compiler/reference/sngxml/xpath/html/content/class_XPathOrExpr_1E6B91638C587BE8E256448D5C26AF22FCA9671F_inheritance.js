...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathOrExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathOrExpr_1E6B91638C587BE8E256448D5C26AF22FCA9671F.html" }];
    drawDiagram(classes);
}
