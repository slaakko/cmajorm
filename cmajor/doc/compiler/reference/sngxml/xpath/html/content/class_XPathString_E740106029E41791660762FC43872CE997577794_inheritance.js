...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathString", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathString_E740106029E41791660762FC43872CE997577794.html" }];
    drawDiagram(classes);
}
