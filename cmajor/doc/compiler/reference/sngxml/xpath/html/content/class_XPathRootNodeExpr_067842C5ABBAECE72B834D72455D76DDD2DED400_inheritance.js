...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathRootNodeExpr", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathRootNodeExpr_067842C5ABBAECE72B834D72455D76DDD2DED400.html" }];
    drawDiagram(classes);
}
