...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathMulExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathMulExpr_93EE08FAB08F425DA0D326A143CBD1C90B856905.html" }];
    drawDiagram(classes);
}
