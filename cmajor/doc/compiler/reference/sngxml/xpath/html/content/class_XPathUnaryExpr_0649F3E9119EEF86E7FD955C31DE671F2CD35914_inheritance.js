...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathUnaryExpr", id: "class_1", level: 1, subject: true, hasDerivedClasses: true, link: "./class_XPathUnaryExpr_0649F3E9119EEF86E7FD955C31DE671F2CD35914.html" },
        { name: "sngxml::xpath::XPathFilterExpr", id: "class_2", level: 2, subject: false, hasDerivedClasses: false, link: "./class_XPathFilterExpr_98FD491A1F300907213439997EF0BC55E9930D5F.html" },
        { name: "sngxml::xpath::XPathUnaryMinusExpr", id: "class_3", level: 2, subject: false, hasDerivedClasses: false, link: "./class_XPathUnaryMinusExpr_7904BFA1A19F0F2E123BD5AA742C41EB96AD1CF1.html" }];
    drawDiagram(classes);
}
