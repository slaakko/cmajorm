...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathNotEqualExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathNotEqualExpr_CBFE69B8485ADE7BB16AD2A28317338F4B4F6F2C.html" }];
    drawDiagram(classes);
}
