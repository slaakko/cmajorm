...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathLiteral", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathLiteral_F5281DE7693296011357CFAD0DCBBE30EAA9AACF.html" }];
    drawDiagram(classes);
}
