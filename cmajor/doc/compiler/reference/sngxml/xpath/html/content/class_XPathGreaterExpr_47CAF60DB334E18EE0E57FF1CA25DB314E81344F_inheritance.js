...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathGreaterExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_XPathGreaterExpr_47CAF60DB334E18EE0E57FF1CA25DB314E81344F.html" }];
    drawDiagram(classes);
}
