...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::xpath::XPathFunctionCall", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_XPathFunctionCall_0F67CA9DCE33B04E30A8731E730478A51C718169.html" }];
    drawDiagram(classes);
}
