...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sngxml::dom::Visitor", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./../../../dom/html/content/class_Visitor_549B96ACB368AD0D5131C27F98981FCD740BCCE0.html" },
        { name: "sngxml::xpath::ElementAndDocumentStringValueComputer", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./struct_ElementAndDocumentStringValueComputer_D8FA0F0F356FA4432F4C5983D2EF076FF1F36EB6.html" }];
    drawDiagram(classes);
}
