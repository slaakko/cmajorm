...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::dom::BuildIndexVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BuildIndexVisitor_FB924A4E155CA4BA2B8D0A175C41EDC5C1045AF8.html" }];
    drawDiagram(classes);
}
