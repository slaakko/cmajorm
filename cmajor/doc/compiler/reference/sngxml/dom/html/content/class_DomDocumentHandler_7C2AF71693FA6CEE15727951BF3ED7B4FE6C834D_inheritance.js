...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngxml::dom::DomDocumentHandler", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DomDocumentHandler_7C2AF71693FA6CEE15727951BF3ED7B4FE6C834D.html" }];
    drawDiagram(classes);
}
