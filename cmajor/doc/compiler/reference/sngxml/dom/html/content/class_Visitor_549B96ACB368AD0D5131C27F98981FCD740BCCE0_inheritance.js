...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sngxml::dom::Visitor", id: "class_0", level: 0, subject: true, hasDerivedClasses: true, link: "./class_Visitor_549B96ACB368AD0D5131C27F98981FCD740BCCE0.html" },
        { name: "sngxml::dom::BuildIndexVisitor", id: "class_1", level: 1, subject: false, hasDerivedClasses: false, link: "./class_BuildIndexVisitor_FB924A4E155CA4BA2B8D0A175C41EDC5C1045AF8.html" },
        { name: "sngxml::dom::ElementsByTagNameVisitor", id: "class_2", level: 1, subject: false, hasDerivedClasses: false, link: "./class_ElementsByTagNameVisitor_0348E91ADC90722A48EB190BEB57194481DEF53C.html" }];
    drawDiagram(classes);
}
