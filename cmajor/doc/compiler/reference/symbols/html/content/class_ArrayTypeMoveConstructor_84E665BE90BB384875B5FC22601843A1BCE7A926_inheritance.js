...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayTypeMoveConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ArrayTypeMoveConstructor_84E665BE90BB384875B5FC22601843A1BCE7A926.html" }];
    drawDiagram(classes);
}
