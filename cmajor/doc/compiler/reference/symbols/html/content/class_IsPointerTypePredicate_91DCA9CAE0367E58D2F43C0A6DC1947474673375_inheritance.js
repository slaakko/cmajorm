...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsPointerTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsPointerTypePredicate_91DCA9CAE0367E58D2F43C0A6DC1947474673375.html" }];
    drawDiagram(classes);
}
