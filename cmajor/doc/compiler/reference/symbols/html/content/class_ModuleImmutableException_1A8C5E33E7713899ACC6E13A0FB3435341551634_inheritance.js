...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ModuleImmutableException", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ModuleImmutableException_1A8C5E33E7713899ACC6E13A0FB3435341551634.html" }];
    drawDiagram(classes);
}
