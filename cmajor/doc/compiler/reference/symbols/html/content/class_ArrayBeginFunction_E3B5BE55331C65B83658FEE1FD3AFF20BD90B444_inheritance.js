...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayBeginFunction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ArrayBeginFunction_E3B5BE55331C65B83658FEE1FD3AFF20BD90B444.html" }];
    drawDiagram(classes);
}
