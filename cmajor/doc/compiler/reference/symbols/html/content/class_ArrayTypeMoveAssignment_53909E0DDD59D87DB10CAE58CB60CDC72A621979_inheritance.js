...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayTypeMoveAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ArrayTypeMoveAssignment_53909E0DDD59D87DB10CAE58CB60CDC72A621979.html" }];
    drawDiagram(classes);
}
