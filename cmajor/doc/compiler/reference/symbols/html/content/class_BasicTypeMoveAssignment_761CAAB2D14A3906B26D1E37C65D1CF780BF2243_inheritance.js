...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeMoveAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeMoveAssignment_761CAAB2D14A3906B26D1E37C65D1CF780BF2243.html" }];
    drawDiagram(classes);
}
