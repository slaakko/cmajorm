...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeMoveCtor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeMoveCtor_238784583C9AA743DC72C1383D8312F01001226C.html" }];
    drawDiagram(classes);
}
