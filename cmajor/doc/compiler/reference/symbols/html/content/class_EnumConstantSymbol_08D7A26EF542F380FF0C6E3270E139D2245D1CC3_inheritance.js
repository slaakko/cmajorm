...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumConstantSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_EnumConstantSymbol_08D7A26EF542F380FF0C6E3270E139D2245D1CC3.html" }];
    drawDiagram(classes);
}
