...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayCEndFunction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ArrayCEndFunction_F44549EEC8764EC187641687DCFEA9A4BE987BCB.html" }];
    drawDiagram(classes);
}
