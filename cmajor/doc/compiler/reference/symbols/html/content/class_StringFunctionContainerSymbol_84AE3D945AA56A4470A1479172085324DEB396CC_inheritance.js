...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::StringFunctionContainerSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_StringFunctionContainerSymbol_84AE3D945AA56A4470A1479172085324DEB396CC.html" }];
    drawDiagram(classes);
}
