...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsWCharTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsWCharTypePredicate_0AEECB3286E3A102957843CD74D1BEE0945EFAB8.html" }];
    drawDiagram(classes);
}
