...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeEqualityOp", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_EnumTypeEqualityOp_5084535E8D8FB127786A5174AFA46DB9A16A4CA3.html" }];
    drawDiagram(classes);
}
