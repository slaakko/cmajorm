...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ClassDelegateTypeEquality", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ClassDelegateTypeEquality_D8D11D96DE90CF96621C142F8A3ED787FAF9A616.html" }];
    drawDiagram(classes);
}
