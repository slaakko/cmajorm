...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeDefaultWCharOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeDefaultWCharOperation_0E24A9C1E2380661FBF44378661974EB0FEE75AA.html" }];
    drawDiagram(classes);
}
