...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::InterfaceTypeCopyConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_InterfaceTypeCopyConstructor_1D43C871BC43BB0E814AECB6C6F64C3C8E6A9A7C.html" }];
    drawDiagram(classes);
}
