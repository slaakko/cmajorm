...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::StringLengthFunction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_StringLengthFunction_E3506646CDDF4E6606AADB2097ECE07162729FB5.html" }];
    drawDiagram(classes);
}
