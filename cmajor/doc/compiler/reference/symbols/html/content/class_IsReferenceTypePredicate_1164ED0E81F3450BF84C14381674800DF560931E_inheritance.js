...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsReferenceTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsReferenceTypePredicate_1164ED0E81F3450BF84C14381674800DF560931E.html" }];
    drawDiagram(classes);
}
