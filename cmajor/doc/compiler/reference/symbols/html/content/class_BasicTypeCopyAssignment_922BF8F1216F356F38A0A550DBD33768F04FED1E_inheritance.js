...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeCopyAssignment_922BF8F1216F356F38A0A550DBD33768F04FED1E.html" }];
    drawDiagram(classes);
}
