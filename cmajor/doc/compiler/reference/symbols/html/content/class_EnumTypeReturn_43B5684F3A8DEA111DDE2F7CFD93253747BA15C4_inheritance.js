...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeReturn", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_EnumTypeReturn_43B5684F3A8DEA111DDE2F7CFD93253747BA15C4.html" }];
    drawDiagram(classes);
}
