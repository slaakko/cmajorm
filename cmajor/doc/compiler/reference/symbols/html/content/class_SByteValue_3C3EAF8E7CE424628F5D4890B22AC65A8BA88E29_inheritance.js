...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::SByteValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SByteValue_3C3EAF8E7CE424628F5D4890B22AC65A8BA88E29.html" }];
    drawDiagram(classes);
}
