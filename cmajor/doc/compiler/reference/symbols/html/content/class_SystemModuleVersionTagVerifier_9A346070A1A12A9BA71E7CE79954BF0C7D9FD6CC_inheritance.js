...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sngcm::ast::ModuleVersionTagVerifier", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./../../../sngcm/ast/html/content/class_ModuleVersionTagVerifier_604C71B183F2525066E1952A6AAFAE0E44884187.html" },
        { name: "cmajor::symbols::SystemModuleVersionTagVerifier", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SystemModuleVersionTagVerifier_9A346070A1A12A9BA71E7CE79954BF0C7D9FD6CC.html" }];
    drawDiagram(classes);
}
