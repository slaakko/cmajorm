...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::FunctionGroupSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FunctionGroupSymbol_ADD9128234E8CBDCA551DECFEB138ABA2C75FD11.html" }];
    drawDiagram(classes);
}
