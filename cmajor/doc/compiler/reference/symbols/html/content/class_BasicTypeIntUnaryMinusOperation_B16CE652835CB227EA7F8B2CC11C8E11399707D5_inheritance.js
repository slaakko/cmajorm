...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeIntUnaryMinusOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeIntUnaryMinusOperation_B16CE652835CB227EA7F8B2CC11C8E11399707D5.html" }];
    drawDiagram(classes);
}
