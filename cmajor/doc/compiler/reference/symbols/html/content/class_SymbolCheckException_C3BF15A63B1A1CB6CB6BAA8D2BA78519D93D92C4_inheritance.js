...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::SymbolCheckException", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SymbolCheckException_C3BF15A63B1A1CB6CB6BAA8D2BA78519D93D92C4.html" }];
    drawDiagram(classes);
}
