...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sngcm::ast::Visitor", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./../../../sngcm/ast/html/content/class_Visitor_EE4D58A199693C26BFFAD637A3ADC818BC5994FC.html" },
        { name: "cmajor::symbols::SymbolCreatorVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SymbolCreatorVisitor_5ED8400607A86B5052CD520D65326DCEDCDF2CF7.html" }];
    drawDiagram(classes);
}
