...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateTypeDefaultConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_DelegateTypeDefaultConstructor_67AC30667126234A4FE4638DE9DF9725247B4B3E.html" }];
    drawDiagram(classes);
}
