...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::GlobalVariableGroupSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GlobalVariableGroupSymbol_6534FCF8C9DED89040A0E988D9E069B4F9287893.html" }];
    drawDiagram(classes);
}
