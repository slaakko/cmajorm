...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::InterfaceTypeCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_InterfaceTypeCopyAssignment_2A0FA136C0242AD1764F1EE1A8FF4136D53A634F.html" }];
    drawDiagram(classes);
}
