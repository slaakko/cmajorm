...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::VoidPtrToDelegateConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_VoidPtrToDelegateConversion_F1B289CFA68B441FC9CC603F4AF2889029684299.html" }];
    drawDiagram(classes);
}
