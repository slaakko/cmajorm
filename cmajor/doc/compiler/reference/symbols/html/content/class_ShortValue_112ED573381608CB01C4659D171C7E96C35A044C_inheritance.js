...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ShortValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ShortValue_112ED573381608CB01C4659D171C7E96C35A044C.html" }];
    drawDiagram(classes);
}
