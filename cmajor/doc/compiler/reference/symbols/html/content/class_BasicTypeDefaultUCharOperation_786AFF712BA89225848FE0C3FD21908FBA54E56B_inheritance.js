...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeDefaultUCharOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeDefaultUCharOperation_786AFF712BA89225848FE0C3FD21908FBA54E56B.html" }];
    drawDiagram(classes);
}
