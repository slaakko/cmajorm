...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ConceptGroupSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConceptGroupSymbol_4F31355C6A0CED9D324FA100B698ECC4A926CE90.html" }];
    drawDiagram(classes);
}
