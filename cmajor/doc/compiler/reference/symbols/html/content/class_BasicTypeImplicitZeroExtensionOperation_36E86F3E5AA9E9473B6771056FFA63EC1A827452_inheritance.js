...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeImplicitZeroExtensionOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeImplicitZeroExtensionOperation_36E86F3E5AA9E9473B6771056FFA63EC1A827452.html" }];
    drawDiagram(classes);
}
