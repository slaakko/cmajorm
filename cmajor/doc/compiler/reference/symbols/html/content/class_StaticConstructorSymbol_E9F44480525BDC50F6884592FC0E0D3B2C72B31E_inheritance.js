...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::StaticConstructorSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_StaticConstructorSymbol_E9F44480525BDC50F6884592FC0E0D3B2C72B31E.html" }];
    drawDiagram(classes);
}
