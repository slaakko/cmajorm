...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeDefaultSInt64Operation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeDefaultSInt64Operation_C0D82B9A953AA31B7EC953D7CB5FB20F3B2FD8FB.html" }];
    drawDiagram(classes);
}
