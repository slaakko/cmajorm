...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::LongValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LongValue_1BD265CB5802007DF44E57306A8CE9482A5A8B33.html" }];
    drawDiagram(classes);
}
