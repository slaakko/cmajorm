...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ClassDelegateTypeMoveConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ClassDelegateTypeMoveConstructor_6629D67090B2622D53C7D767CEFCA75702884464.html" }];
    drawDiagram(classes);
}
