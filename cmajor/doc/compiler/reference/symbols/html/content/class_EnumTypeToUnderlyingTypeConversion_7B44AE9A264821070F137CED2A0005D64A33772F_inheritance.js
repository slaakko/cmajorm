...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeToUnderlyingTypeConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_EnumTypeToUnderlyingTypeConversion_7B44AE9A264821070F137CED2A0005D64A33772F.html" }];
    drawDiagram(classes);
}
