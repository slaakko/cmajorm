...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::LocalVariableSymbol", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LocalVariableSymbol_F5A9F74EEFC0001129616C5EEBCFE3B2DFC74FCF.html" }];
    drawDiagram(classes);
}
