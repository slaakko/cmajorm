...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ClassDelegateTypeCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ClassDelegateTypeCopyAssignment_5EAB185C58F584FDD22422B76853A7652D7E1301.html" }];
    drawDiagram(classes);
}
