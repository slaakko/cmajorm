...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::MemberFunctionToClassDelegateConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_MemberFunctionToClassDelegateConversion_6CA93A3F92B3723079C3A15901A0CBFFB0D119BC.html" }];
    drawDiagram(classes);
}
