...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BoolValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoolValue_34FB4C955731A946B618B4AC8909FE8833ECAA6E.html" }];
    drawDiagram(classes);
}
