...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BoolTypeSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_BoolTypeSymbol_6969CE37875C7FA155DEE00293E5045E2A62686D.html" }];
    drawDiagram(classes);
}
