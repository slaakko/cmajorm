...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_EnumTypeCopyAssignment_B5FB3C462C4DE7DDFFFB97579854AA6D7B740D8A.html" }];
    drawDiagram(classes);
}
