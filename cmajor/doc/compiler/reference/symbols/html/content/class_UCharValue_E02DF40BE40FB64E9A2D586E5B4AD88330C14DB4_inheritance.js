...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::UCharValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_UCharValue_E02DF40BE40FB64E9A2D586E5B4AD88330C14DB4.html" }];
    drawDiagram(classes);
}
