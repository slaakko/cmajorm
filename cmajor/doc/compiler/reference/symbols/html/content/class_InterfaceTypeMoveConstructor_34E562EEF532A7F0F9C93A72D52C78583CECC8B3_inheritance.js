...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::InterfaceTypeMoveConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_InterfaceTypeMoveConstructor_34E562EEF532A7F0F9C93A72D52C78583CECC8B3.html" }];
    drawDiagram(classes);
}
