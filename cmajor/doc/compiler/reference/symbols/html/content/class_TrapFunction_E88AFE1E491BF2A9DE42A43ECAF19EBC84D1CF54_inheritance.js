...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::TrapFunction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_TrapFunction_E88AFE1E491BF2A9DE42A43ECAF19EBC84D1CF54.html" }];
    drawDiagram(classes);
}
