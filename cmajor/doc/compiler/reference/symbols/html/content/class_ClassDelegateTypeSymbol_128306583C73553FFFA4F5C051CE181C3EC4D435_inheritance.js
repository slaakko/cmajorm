...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ClassDelegateTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ClassDelegateTypeSymbol_128306583C73553FFFA4F5C051CE181C3EC4D435.html" }];
    drawDiagram(classes);
}
