...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeExplicitSignedIntToFloatingOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeExplicitSignedIntToFloatingOperation_4B27738F53F6BE4F0993676823D12938EBFCD5C4.html" }];
    drawDiagram(classes);
}
