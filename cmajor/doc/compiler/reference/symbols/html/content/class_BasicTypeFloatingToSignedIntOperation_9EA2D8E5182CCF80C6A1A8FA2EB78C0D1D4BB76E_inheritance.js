...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeFloatingToSignedIntOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeFloatingToSignedIntOperation_9EA2D8E5182CCF80C6A1A8FA2EB78C0D1D4BB76E.html" }];
    drawDiagram(classes);
}
