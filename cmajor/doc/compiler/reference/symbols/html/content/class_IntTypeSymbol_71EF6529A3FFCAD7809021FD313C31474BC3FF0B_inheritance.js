...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IntTypeSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_IntTypeSymbol_71EF6529A3FFCAD7809021FD313C31474BC3FF0B.html" }];
    drawDiagram(classes);
}
