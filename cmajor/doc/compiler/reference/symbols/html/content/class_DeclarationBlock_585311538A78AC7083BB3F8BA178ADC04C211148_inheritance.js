...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DeclarationBlock", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DeclarationBlock_585311538A78AC7083BB3F8BA178ADC04C211148.html" }];
    drawDiagram(classes);
}
