...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_EnumTypeSymbol_2BAAB2A27ED9B0673A8BDB522815996A62559E4E.html" }];
    drawDiagram(classes);
}
