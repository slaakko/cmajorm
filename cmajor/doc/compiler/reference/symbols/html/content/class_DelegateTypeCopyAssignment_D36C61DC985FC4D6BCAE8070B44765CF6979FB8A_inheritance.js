...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateTypeCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_DelegateTypeCopyAssignment_D36C61DC985FC4D6BCAE8070B44765CF6979FB8A.html" }];
    drawDiagram(classes);
}
