...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ULongValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ULongValue_985C867DFFEE6DF3901A8074F6E0C0271BFD0427.html" }];
    drawDiagram(classes);
}
