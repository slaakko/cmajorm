...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::MemberFunctionSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_MemberFunctionSymbol_3BF2D77D69165719C9D08538201EC0A12DBC5B03.html" }];
    drawDiagram(classes);
}
