...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::WCharTypeSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_WCharTypeSymbol_E6EF2B74E358F65818008AB1882CEA15EFC64A1C.html" }];
    drawDiagram(classes);
}
