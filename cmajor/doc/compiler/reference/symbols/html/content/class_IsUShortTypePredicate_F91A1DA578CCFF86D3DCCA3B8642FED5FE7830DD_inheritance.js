...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsUShortTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsUShortTypePredicate_F91A1DA578CCFF86D3DCCA3B8642FED5FE7830DD.html" }];
    drawDiagram(classes);
}
