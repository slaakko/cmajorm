...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsDelegateTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsDelegateTypePredicate_DFB54E30F0BE81650AA15386F7031D3394AB973A.html" }];
    drawDiagram(classes);
}
