...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::CharValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CharValue_A2EBC5C85E91182D5D56754965416472645563C5.html" }];
    drawDiagram(classes);
}
