...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeBitCastOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeBitCastOperation_214F51A321F0F0D3004D5144DE007517BD98C13A.html" }];
    drawDiagram(classes);
}
