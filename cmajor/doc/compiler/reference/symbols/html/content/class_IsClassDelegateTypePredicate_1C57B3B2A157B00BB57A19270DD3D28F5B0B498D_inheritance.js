...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsClassDelegateTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsClassDelegateTypePredicate_1C57B3B2A157B00BB57A19270DD3D28F5B0B498D.html" }];
    drawDiagram(classes);
}
