...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ShortTypeSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_ShortTypeSymbol_2BCD1E9A51BB519BF3F50428AB2B0223A5D9ED0D.html" }];
    drawDiagram(classes);
}
