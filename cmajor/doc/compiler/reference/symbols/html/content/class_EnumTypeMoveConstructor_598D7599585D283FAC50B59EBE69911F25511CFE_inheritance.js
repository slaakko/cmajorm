...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeMoveConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_EnumTypeMoveConstructor_598D7599585D283FAC50B59EBE69911F25511CFE.html" }];
    drawDiagram(classes);
}
