...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::FunctionToDelegateConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_FunctionToDelegateConversion_528ACF569CD05CE5D8431A13AF117DAAFC3FB1FE.html" }];
    drawDiagram(classes);
}
