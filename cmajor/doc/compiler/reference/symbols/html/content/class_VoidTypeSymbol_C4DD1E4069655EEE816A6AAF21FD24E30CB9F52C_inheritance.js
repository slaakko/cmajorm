...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::VoidTypeSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_VoidTypeSymbol_C4DD1E4069655EEE816A6AAF21FD24E30CB9F52C.html" }];
    drawDiagram(classes);
}
