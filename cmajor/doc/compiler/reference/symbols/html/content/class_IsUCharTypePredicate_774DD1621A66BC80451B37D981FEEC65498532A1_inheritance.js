...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsUCharTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsUCharTypePredicate_774DD1621A66BC80451B37D981FEEC65498532A1.html" }];
    drawDiagram(classes);
}
