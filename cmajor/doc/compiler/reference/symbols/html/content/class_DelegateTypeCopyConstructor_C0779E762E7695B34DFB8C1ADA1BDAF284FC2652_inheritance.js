...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateTypeCopyConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_DelegateTypeCopyConstructor_C0779E762E7695B34DFB8C1ADA1BDAF284FC2652.html" }];
    drawDiagram(classes);
}
