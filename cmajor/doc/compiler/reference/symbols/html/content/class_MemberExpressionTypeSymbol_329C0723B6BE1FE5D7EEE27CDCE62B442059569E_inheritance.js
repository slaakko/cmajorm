...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::MemberExpressionTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_MemberExpressionTypeSymbol_329C0723B6BE1FE5D7EEE27CDCE62B442059569E.html" }];
    drawDiagram(classes);
}
