...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeFloatingToUnsignedIntOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeFloatingToUnsignedIntOperation_FF1CD77441BC42DA28E321AC9FD2308979248CEB.html" }];
    drawDiagram(classes);
}
