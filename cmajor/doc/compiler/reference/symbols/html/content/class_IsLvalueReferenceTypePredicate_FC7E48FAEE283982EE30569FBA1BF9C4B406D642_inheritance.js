...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsLvalueReferenceTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsLvalueReferenceTypePredicate_FC7E48FAEE283982EE30569FBA1BF9C4B406D642.html" }];
    drawDiagram(classes);
}
