...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeDefaultUInt8Operation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeDefaultUInt8Operation_6EDFC827FF8FEDC0DB128DEC30C46667C6C51CB0.html" }];
    drawDiagram(classes);
}
