...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsIntTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsIntTypePredicate_31A4CC4ABE5DD8931E8CBC09D64D2338B2D00FB7.html" }];
    drawDiagram(classes);
}
