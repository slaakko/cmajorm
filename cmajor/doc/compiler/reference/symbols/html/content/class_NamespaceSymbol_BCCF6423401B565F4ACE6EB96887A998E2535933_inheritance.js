...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::NamespaceSymbol", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NamespaceSymbol_BCCF6423401B565F4ACE6EB96887A998E2535933.html" }];
    drawDiagram(classes);
}
