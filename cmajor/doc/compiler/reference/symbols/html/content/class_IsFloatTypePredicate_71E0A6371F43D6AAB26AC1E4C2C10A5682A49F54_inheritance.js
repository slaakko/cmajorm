...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsFloatTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsFloatTypePredicate_71E0A6371F43D6AAB26AC1E4C2C10A5682A49F54.html" }];
    drawDiagram(classes);
}
