...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsByteTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsByteTypePredicate_041ADCDA4C047E94DFC3ED902BC629B489522AEB.html" }];
    drawDiagram(classes);
}
