...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeLShrOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_BasicTypeLShrOperation_C96CDCAA8B2C1DDC7499AA37E7C266C49498D6D4.html" }];
    drawDiagram(classes);
}
