...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::CannotAssignToConstOverloadException", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CannotAssignToConstOverloadException_4BD4893331BF0A01E1660A86442C12896BB79936.html" }];
    drawDiagram(classes);
}
