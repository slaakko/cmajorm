...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateToVoidPtrConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_DelegateToVoidPtrConversion_F294F90D68A92528AB98BF87B0A85BE8288259C9.html" }];
    drawDiagram(classes);
}
