...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::InterfaceTypeMoveAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_InterfaceTypeMoveAssignment_B1B4158704A84E54E75033B6CF269354A40D3D3C.html" }];
    drawDiagram(classes);
}
