...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ClassDelegateTypeCopyConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ClassDelegateTypeCopyConstructor_7342591B087266A07DAF19DCA6DF4EFAAC9091EB.html" }];
    drawDiagram(classes);
}
