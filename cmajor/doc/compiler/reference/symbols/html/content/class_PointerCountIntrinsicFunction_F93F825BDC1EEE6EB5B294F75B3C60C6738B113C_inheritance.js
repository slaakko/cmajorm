...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::PointerCountIntrinsicFunction", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_PointerCountIntrinsicFunction_F93F825BDC1EEE6EB5B294F75B3C60C6738B113C.html" }];
    drawDiagram(classes);
}
