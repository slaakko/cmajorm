...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::LessOrEqualNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LessOrEqualNode_DAAF2E7A80A91276BD27D9174083269CE11B4A4E.html" }];
    drawDiagram(classes);
}
