...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DestructorNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DestructorNode_AFEC264A02A21CAD7984D4238496C9206B395DC7.html" }];
    drawDiagram(classes);
}
