...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::EmptyStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_EmptyStatementNode_5CBD3ACBC8697E702600BE0356BD96A1F574096D.html" }];
    drawDiagram(classes);
}
