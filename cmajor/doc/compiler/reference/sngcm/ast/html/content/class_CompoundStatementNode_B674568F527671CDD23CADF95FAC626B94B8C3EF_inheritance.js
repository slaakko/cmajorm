...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::CompoundStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CompoundStatementNode_B674568F527671CDD23CADF95FAC626B94B8C3EF.html" }];
    drawDiagram(classes);
}
