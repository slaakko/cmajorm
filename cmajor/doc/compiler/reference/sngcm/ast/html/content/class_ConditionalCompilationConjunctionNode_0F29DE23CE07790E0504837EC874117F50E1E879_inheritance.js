...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConditionalCompilationConjunctionNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ConditionalCompilationConjunctionNode_0F29DE23CE07790E0504837EC874117F50E1E879.html" }];
    drawDiagram(classes);
}
