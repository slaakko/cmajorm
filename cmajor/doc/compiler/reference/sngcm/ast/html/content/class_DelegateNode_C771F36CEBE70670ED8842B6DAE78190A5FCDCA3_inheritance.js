...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DelegateNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DelegateNode_C771F36CEBE70670ED8842B6DAE78190A5FCDCA3.html" }];
    drawDiagram(classes);
}
