...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::IsConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IsConstraintNode_B4FEA6623CF9ED2F9C481C5F78321D55CE17703B.html" }];
    drawDiagram(classes);
}
