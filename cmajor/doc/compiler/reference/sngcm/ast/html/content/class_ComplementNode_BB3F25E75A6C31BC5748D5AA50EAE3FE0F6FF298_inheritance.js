...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ComplementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ComplementNode_BB3F25E75A6C31BC5748D5AA50EAE3FE0F6FF298.html" }];
    drawDiagram(classes);
}
