...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ReferenceDeclaration", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ReferenceDeclaration_D373FBD4E9372B14DBD920F41E12D3004095008B.html" }];
    drawDiagram(classes);
}
