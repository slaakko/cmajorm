...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::MemberFunctionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_MemberFunctionNode_3C187324BA745275B4F4E363249A699C9DAEBAAA.html" }];
    drawDiagram(classes);
}
