...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::UuidLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_UuidLiteralNode_8A54D3E9EAC6499E12B4414060F3905DA1361C31.html" }];
    drawDiagram(classes);
}
