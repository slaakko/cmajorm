...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConjunctionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ConjunctionNode_0DA9717654C2645A48D9051285452257E64D79BE.html" }];
    drawDiagram(classes);
}
