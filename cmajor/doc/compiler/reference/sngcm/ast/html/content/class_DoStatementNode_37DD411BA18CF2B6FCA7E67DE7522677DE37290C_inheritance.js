...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DoStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DoStatementNode_37DD411BA18CF2B6FCA7E67DE7522677DE37290C.html" }];
    drawDiagram(classes);
}
