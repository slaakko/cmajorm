...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::GotoStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GotoStatementNode_1B8BD60C4572A005E960AF394053686EC1B1BDEA.html" }];
    drawDiagram(classes);
}
