...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConvertibleConceptNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ConvertibleConceptNode_DA33F57F61FCD010A43392EF960D0617C65B692E.html" }];
    drawDiagram(classes);
}
