...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::TemplateIdNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TemplateIdNode_511FF4648199D13B43B12A897052E66766561252.html" }];
    drawDiagram(classes);
}
