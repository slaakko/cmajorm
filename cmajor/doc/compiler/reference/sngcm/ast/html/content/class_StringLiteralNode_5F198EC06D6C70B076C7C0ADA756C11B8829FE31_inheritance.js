...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::StringLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_StringLiteralNode_5F198EC06D6C70B076C7C0ADA756C11B8829FE31.html" }];
    drawDiagram(classes);
}
