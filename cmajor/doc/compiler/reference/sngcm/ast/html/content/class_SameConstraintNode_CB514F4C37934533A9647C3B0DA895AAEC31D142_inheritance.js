...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::SameConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_SameConstraintNode_CB514F4C37934533A9647C3B0DA895AAEC31D142.html" }];
    drawDiagram(classes);
}
