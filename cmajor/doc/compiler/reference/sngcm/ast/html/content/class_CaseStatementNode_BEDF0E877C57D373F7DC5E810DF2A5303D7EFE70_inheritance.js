...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::CaseStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CaseStatementNode_BEDF0E877C57D373F7DC5E810DF2A5303D7EFE70.html" }];
    drawDiagram(classes);
}
