...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::LValueRefNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LValueRefNode_5F81C4F2A34E2029B768017805FF11E9A326CEA6.html" }];
    drawDiagram(classes);
}
