...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::NullLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NullLiteralNode_D3A1DD6B6CE29BA06293220DCDD0B127D6191A14.html" }];
    drawDiagram(classes);
}
