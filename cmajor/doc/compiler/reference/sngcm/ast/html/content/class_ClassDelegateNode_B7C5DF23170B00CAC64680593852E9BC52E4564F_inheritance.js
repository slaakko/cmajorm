...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ClassDelegateNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ClassDelegateNode_B7C5DF23170B00CAC64680593852E9BC52E4564F.html" }];
    drawDiagram(classes);
}
