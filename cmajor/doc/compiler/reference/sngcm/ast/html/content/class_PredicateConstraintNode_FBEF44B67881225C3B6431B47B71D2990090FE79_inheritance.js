...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::PredicateConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PredicateConstraintNode_FBEF44B67881225C3B6431B47B71D2990090FE79.html" }];
    drawDiagram(classes);
}
