...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DefaultStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DefaultStatementNode_44FB7E87C35E222F8A2DF2B7E8B4D8F6B11B6EE9.html" }];
    drawDiagram(classes);
}
