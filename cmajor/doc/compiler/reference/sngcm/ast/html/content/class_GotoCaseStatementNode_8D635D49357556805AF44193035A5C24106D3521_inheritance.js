...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::GotoCaseStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GotoCaseStatementNode_8D635D49357556805AF44193035A5C24106D3521.html" }];
    drawDiagram(classes);
}
