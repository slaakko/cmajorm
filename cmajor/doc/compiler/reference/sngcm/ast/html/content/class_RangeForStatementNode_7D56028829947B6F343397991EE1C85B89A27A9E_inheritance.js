...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::RangeForStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_RangeForStatementNode_7D56028829947B6F343397991EE1C85B89A27A9E.html" }];
    drawDiagram(classes);
}
