...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ImplicationNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ImplicationNode_189EC504F45793A4188A6DF9B68BEC8B3C92EC1F.html" }];
    drawDiagram(classes);
}
