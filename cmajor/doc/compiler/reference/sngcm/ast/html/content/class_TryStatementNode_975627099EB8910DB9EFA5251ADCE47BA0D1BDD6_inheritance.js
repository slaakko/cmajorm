...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::TryStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_TryStatementNode_975627099EB8910DB9EFA5251ADCE47BA0D1BDD6.html" }];
    drawDiagram(classes);
}
