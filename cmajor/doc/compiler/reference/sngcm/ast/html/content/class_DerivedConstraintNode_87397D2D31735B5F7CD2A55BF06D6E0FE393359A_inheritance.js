...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DerivedConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_DerivedConstraintNode_87397D2D31735B5F7CD2A55BF06D6E0FE393359A.html" }];
    drawDiagram(classes);
}
