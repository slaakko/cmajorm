...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::PointerNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_PointerNode_C30FB1E28226404DA13D72F1CD82CB9BCECC8C34.html" }];
    drawDiagram(classes);
}
