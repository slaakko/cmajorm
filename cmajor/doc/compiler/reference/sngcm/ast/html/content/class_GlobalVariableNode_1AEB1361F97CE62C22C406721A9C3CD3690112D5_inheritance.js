...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::GlobalVariableNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GlobalVariableNode_1AEB1361F97CE62C22C406721A9C3CD3690112D5.html" }];
    drawDiagram(classes);
}
