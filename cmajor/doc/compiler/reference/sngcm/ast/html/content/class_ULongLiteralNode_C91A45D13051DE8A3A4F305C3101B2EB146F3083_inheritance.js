...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ULongLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ULongLiteralNode_C91A45D13051DE8A3A4F305C3101B2EB146F3083.html" }];
    drawDiagram(classes);
}
