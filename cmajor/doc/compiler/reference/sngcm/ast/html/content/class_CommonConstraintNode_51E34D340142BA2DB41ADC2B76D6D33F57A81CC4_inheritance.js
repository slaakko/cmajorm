...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::CommonConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_CommonConstraintNode_51E34D340142BA2DB41ADC2B76D6D33F57A81CC4.html" }];
    drawDiagram(classes);
}
