...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ArrayLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ArrayLiteralNode_988557EE6037BCFDDA4392AE4C66A2D92D66D766.html" }];
    drawDiagram(classes);
}
