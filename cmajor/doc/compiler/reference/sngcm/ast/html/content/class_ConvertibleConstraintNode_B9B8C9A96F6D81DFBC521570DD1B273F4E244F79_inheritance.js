...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConvertibleConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ConvertibleConstraintNode_B9B8C9A96F6D81DFBC521570DD1B273F4E244F79.html" }];
    drawDiagram(classes);
}
