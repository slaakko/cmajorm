...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ExpressionStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ExpressionStatementNode_7B6C0F611CAF2344AFC296E472A12995E2A2DC1F.html" }];
    drawDiagram(classes);
}
