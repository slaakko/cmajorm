...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::UnaryMinusNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_UnaryMinusNode_FE5C9C78B9E8BD832B00578BBD225B17D3F00CD8.html" }];
    drawDiagram(classes);
}
