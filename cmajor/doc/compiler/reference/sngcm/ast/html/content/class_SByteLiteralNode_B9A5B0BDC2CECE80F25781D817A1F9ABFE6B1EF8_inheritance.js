...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::SByteLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_SByteLiteralNode_B9A5B0BDC2CECE80F25781D817A1F9ABFE6B1EF8.html" }];
    drawDiagram(classes);
}
