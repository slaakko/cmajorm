...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::IntrinsicConstraintNode", id: "class_2", level: 2, subject: false, hasDerivedClasses: true, link: "./class_IntrinsicConstraintNode_E958B7436F3E45D119BA41704DBA8A30CD92A5A2.html" },
        { name: "sngcm::ast::ExplicitlyConvertibleConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ExplicitlyConvertibleConstraintNode_3901A2B056E4B4DCD74B5D1F5F623F9E3DBCF438.html" }];
    drawDiagram(classes);
}
