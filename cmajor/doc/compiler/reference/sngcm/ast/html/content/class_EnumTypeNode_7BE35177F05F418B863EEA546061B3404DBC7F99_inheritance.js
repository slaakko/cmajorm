...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::EnumTypeNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_EnumTypeNode_7BE35177F05F418B863EEA546061B3404DBC7F99.html" }];
    drawDiagram(classes);
}
