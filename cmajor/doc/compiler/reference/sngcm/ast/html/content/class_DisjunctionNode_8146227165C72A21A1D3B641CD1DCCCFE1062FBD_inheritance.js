...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DisjunctionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DisjunctionNode_8146227165C72A21A1D3B641CD1DCCCFE1062FBD.html" }];
    drawDiagram(classes);
}
