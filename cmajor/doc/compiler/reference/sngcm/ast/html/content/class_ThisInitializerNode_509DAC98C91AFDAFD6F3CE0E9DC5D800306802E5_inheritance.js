...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ThisInitializerNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ThisInitializerNode_509DAC98C91AFDAFD6F3CE0E9DC5D800306802E5.html" }];
    drawDiagram(classes);
}
