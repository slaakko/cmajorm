...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::BaseInitializerNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_BaseInitializerNode_A11CCD58FA9551262F9DA12A1DC8AB74F43DF894.html" }];
    drawDiagram(classes);
}
