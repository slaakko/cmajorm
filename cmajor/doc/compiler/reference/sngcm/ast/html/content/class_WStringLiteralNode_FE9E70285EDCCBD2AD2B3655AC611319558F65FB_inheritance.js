...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::WStringLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_WStringLiteralNode_FE9E70285EDCCBD2AD2B3655AC611319558F65FB.html" }];
    drawDiagram(classes);
}
