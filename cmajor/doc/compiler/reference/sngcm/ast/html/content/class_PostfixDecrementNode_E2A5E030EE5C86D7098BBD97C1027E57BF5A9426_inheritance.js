...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::PostfixDecrementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PostfixDecrementNode_E2A5E030EE5C86D7098BBD97C1027E57BF5A9426.html" }];
    drawDiagram(classes);
}
