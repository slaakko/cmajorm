...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sngcm::ast::Visitor", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_Visitor_EE4D58A199693C26BFFAD637A3ADC818BC5994FC.html" },
        { name: "sngcm::ast::UnnamedNamespaceProcessor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_UnnamedNamespaceProcessor_3FA2CED94EB2DBF38D8D6A2B8A90F878073D0290.html" }];
    drawDiagram(classes);
}
