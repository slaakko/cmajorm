...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConditionalCompilationDisjunctionNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ConditionalCompilationDisjunctionNode_EC5AB8E52437722C4C7CA8A00FFDE8338C791916.html" }];
    drawDiagram(classes);
}
