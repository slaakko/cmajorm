...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::FullInstantiationRequestNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FullInstantiationRequestNode_5F071A930C085B5F0920E6C87D07CC36F249AD70.html" }];
    drawDiagram(classes);
}
