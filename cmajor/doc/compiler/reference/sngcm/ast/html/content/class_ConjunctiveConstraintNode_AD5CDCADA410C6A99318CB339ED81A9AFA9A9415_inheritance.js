...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConjunctiveConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ConjunctiveConstraintNode_AD5CDCADA410C6A99318CB339ED81A9AFA9A9415.html" }];
    drawDiagram(classes);
}
