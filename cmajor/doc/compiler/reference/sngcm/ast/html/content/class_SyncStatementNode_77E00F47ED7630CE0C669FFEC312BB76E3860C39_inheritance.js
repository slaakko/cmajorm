...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::SyncStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_SyncStatementNode_77E00F47ED7630CE0C669FFEC312BB76E3860C39.html" }];
    drawDiagram(classes);
}
