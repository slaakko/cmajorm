...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConstructorConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ConstructorConstraintNode_646A393757EB598562273202C11934E3F23B7919.html" }];
    drawDiagram(classes);
}
