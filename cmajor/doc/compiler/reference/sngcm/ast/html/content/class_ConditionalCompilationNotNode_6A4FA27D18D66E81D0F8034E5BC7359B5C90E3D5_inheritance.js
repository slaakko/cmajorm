...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConditionalCompilationNotNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ConditionalCompilationNotNode_6A4FA27D18D66E81D0F8034E5BC7359B5C90E3D5.html" }];
    drawDiagram(classes);
}
