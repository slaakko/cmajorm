...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::AssertStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_AssertStatementNode_39A851D1B2800436EC926374E5EEFFA559CCCDB4.html" }];
    drawDiagram(classes);
}
