...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::EnumConstantNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_EnumConstantNode_381A2BE76E395318E6BC73069CF5EBA86913675C.html" }];
    drawDiagram(classes);
}
