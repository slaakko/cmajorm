...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::SwitchStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_SwitchStatementNode_4E903544734E2ECCB83EF97C7628D69A4B681278.html" }];
    drawDiagram(classes);
}
