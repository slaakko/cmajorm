...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ByteLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ByteLiteralNode_B68F4970B8830DF04BE378616376125C60867498.html" }];
    drawDiagram(classes);
}
