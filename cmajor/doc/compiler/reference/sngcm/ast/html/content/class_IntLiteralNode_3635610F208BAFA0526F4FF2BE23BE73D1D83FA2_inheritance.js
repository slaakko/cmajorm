...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::IntLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IntLiteralNode_3635610F208BAFA0526F4FF2BE23BE73D1D83FA2.html" }];
    drawDiagram(classes);
}
