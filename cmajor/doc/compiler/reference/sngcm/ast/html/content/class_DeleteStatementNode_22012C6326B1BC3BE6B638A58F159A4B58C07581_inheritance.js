...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DeleteStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DeleteStatementNode_22012C6326B1BC3BE6B638A58F159A4B58C07581.html" }];
    drawDiagram(classes);
}
