...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ClassMemberArranger", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ClassMemberArranger_1E4185D3EC5764A634765C67E7FF25441AB05C24.html" }];
    drawDiagram(classes);
}
