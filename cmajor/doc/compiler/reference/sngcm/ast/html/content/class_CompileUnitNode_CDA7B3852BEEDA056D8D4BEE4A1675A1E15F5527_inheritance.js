...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::CompileUnitNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CompileUnitNode_CDA7B3852BEEDA056D8D4BEE4A1675A1E15F5527.html" }];
    drawDiagram(classes);
}
