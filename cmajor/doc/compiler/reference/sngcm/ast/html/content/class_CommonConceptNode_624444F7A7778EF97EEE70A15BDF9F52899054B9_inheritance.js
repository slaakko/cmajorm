...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::CommonConceptNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CommonConceptNode_624444F7A7778EF97EEE70A15BDF9F52899054B9.html" }];
    drawDiagram(classes);
}
