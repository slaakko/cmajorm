...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::EquivalenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_EquivalenceNode_4BB6CBD9BAFDFB4E2EE327A4EA535FAC0FBCEE5C.html" }];
    drawDiagram(classes);
}
