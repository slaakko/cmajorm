...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConstructNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConstructNode_37FBC91BB28E4A6E6F08E35CBA2A7C566C551E1D.html" }];
    drawDiagram(classes);
}
