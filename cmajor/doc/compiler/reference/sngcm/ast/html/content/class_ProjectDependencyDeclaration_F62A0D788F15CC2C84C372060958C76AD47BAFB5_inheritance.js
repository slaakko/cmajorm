...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ProjectDependencyDeclaration", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ProjectDependencyDeclaration_F62A0D788F15CC2C84C372060958C76AD47BAFB5.html" }];
    drawDiagram(classes);
}
