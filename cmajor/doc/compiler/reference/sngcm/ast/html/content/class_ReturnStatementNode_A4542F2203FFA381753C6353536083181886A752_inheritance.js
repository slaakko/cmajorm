...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ReturnStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ReturnStatementNode_A4542F2203FFA381753C6353536083181886A752.html" }];
    drawDiagram(classes);
}
