...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::MergeVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_MergeVisitor_E8FFA1FA557BF7F131310905158C5B5EDF5F9BC9.html" }];
    drawDiagram(classes);
}
