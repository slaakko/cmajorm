...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::GreaterNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GreaterNode_61AF553B72A739FCCDF28F4ADA54FBC71D3FC113.html" }];
    drawDiagram(classes);
}
