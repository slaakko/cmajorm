...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DestroyStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DestroyStatementNode_1E4E7A13016963BB5EDBB34D33030F97C5AC9710.html" }];
    drawDiagram(classes);
}
