...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::AttributesNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AttributesNode_B713EAB5359EE5717474CD4C3FFD1AE0ADE44C08.html" }];
    drawDiagram(classes);
}
