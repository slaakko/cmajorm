...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::NodeSelectorVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_NodeSelectorVisitor_AAA270BCE20049B10A2B4588F9EEF8AC78A524A2.html" }];
    drawDiagram(classes);
}
