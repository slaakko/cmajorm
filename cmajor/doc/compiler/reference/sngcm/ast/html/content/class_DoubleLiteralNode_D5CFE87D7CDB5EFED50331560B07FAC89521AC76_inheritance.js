...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::DoubleLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DoubleLiteralNode_D5CFE87D7CDB5EFED50331560B07FAC89521AC76.html" }];
    drawDiagram(classes);
}
