...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::SourceFileDeclaration", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SourceFileDeclaration_574B4145CF15AB4360B8B311FC0FA013F96601BE.html" }];
    drawDiagram(classes);
}
