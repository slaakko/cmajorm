...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::CharLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CharLiteralNode_79B44AD52D16F8D05FD9B71E97FD23B00AE977DD.html" }];
    drawDiagram(classes);
}
