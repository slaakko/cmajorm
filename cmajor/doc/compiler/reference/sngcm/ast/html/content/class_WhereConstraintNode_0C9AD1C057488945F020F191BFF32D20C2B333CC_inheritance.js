...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::WhereConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_WhereConstraintNode_0C9AD1C057488945F020F191BFF32D20C2B333CC.html" }];
    drawDiagram(classes);
}
