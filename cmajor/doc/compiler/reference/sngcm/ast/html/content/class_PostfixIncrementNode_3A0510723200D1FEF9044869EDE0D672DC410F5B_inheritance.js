...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::PostfixIncrementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PostfixIncrementNode_3A0510723200D1FEF9044869EDE0D672DC410F5B.html" }];
    drawDiagram(classes);
}
