...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::UnaryPlusNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_UnaryPlusNode_32CF619985622AD1511854185F327AC47ECCCBE9.html" }];
    drawDiagram(classes);
}
