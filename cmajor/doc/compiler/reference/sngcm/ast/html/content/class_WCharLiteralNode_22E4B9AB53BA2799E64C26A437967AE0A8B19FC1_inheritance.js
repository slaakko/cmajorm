...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::WCharLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_WCharLiteralNode_22E4B9AB53BA2799E64C26A437967AE0A8B19FC1.html" }];
    drawDiagram(classes);
}
