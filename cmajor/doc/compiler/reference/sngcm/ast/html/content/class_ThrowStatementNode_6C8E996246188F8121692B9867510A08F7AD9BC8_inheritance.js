...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ThrowStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ThrowStatementNode_6C8E996246188F8121692B9867510A08F7AD9BC8.html" }];
    drawDiagram(classes);
}
