...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::IfStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IfStatementNode_1C235C4870CD6C151D9B69A60EBA006443EEED71.html" }];
    drawDiagram(classes);
}
