...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ParameterNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ParameterNode_8174A86CB900D2F3FB2B7B55769E36D3F7EE04C1.html" }];
    drawDiagram(classes);
}
