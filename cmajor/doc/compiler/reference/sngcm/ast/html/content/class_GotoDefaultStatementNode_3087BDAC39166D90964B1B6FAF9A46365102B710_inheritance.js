...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::GotoDefaultStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GotoDefaultStatementNode_3087BDAC39166D90964B1B6FAF9A46365102B710.html" }];
    drawDiagram(classes);
}
