...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::IndexingNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_IndexingNode_E13E2574CB0969DB344B18180601055DAD6CF744.html" }];
    drawDiagram(classes);
}
