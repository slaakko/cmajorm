...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::FunctionPtrNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FunctionPtrNode_38CAE4C0151318A53D6FD695F7542FFB83B80F94.html" }];
    drawDiagram(classes);
}
