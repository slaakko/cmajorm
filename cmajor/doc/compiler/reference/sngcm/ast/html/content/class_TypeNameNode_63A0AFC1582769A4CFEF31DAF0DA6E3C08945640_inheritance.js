...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::TypeNameNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TypeNameNode_63A0AFC1582769A4CFEF31DAF0DA6E3C08945640.html" }];
    drawDiagram(classes);
}
