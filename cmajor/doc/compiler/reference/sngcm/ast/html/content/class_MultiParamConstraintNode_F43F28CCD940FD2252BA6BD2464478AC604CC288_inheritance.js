...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::MultiParamConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_MultiParamConstraintNode_F43F28CCD940FD2252BA6BD2464478AC604CC288.html" }];
    drawDiagram(classes);
}
