...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::BreakStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_BreakStatementNode_08DB9BD78E7635D6E5D28CF2BEE7A990BE44FB05.html" }];
    drawDiagram(classes);
}
