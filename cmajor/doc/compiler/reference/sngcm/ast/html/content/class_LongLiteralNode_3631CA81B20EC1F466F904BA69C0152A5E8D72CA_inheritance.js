...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::LongLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LongLiteralNode_3631CA81B20EC1F466F904BA69C0152A5E8D72CA.html" }];
    drawDiagram(classes);
}
