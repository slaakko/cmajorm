...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConditionalCompilationExpressionNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: true, link: "./class_ConditionalCompilationExpressionNode_0E2A9F385165FF3648A34BD21A6EF60DC2D98B5D.html" },
        { name: "sngcm::ast::ConditionalCompilationBinaryExpressionNode", id: "class_2", level: 2, subject: false, hasDerivedClasses: true, link: "./class_ConditionalCompilationBinaryExpressionNode_69469DE0B62CFAA8335E6B77ABD7C89528C54F7A.html" },
        { name: "sngcm::ast::ConditionalCompilationNotNode", id: "class_3", level: 2, subject: false, hasDerivedClasses: false, link: "./class_ConditionalCompilationNotNode_6A4FA27D18D66E81D0F8034E5BC7359B5C90E3D5.html" },
        { name: "sngcm::ast::ConditionalCompilationPrimaryNode", id: "class_4", level: 2, subject: false, hasDerivedClasses: false, link: "./class_ConditionalCompilationPrimaryNode_07E923476280F9B1A773646758E72E2755611A86.html" },
        { name: "sngcm::ast::ParenthesizedConditionalCompilationExpressionNode", id: "class_5", level: 2, subject: false, hasDerivedClasses: false, link: "./class_ParenthesizedConditionalCompilationExpressionNode_9C59C5AF1CE9E14A183B1ED2F3E4A8C1600FF78D.html" }];
    drawDiagram(classes);
}
