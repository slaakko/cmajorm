...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::AssignmentStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_AssignmentStatementNode_32213D3A2A091C640F8FFA06FDCCFC52462354A0.html" }];
    drawDiagram(classes);
}
