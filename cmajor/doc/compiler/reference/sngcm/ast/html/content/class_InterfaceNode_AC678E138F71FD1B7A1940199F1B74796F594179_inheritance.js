...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::InterfaceNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InterfaceNode_AC678E138F71FD1B7A1940199F1B74796F594179.html" }];
    drawDiagram(classes);
}
