...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::SolutionProjectDeclaration", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SolutionProjectDeclaration_668E82C878D7BA88B0622DDD153968337179012A.html" }];
    drawDiagram(classes);
}
