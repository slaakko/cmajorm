...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::WhileStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_WhileStatementNode_C25A3DF1F33DC6448A67FF7E5A1443A7B7196861.html" }];
    drawDiagram(classes);
}
