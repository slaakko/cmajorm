...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::TargetDeclaration", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TargetDeclaration_DD5FD0BB0D1128FC27CA2C5BF1DEA1470AE024DD.html" }];
    drawDiagram(classes);
}
