...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::NonreferenceTypeConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_NonreferenceTypeConstraintNode_E719BF0A279149E672F36F4C5B775A6381391B3D.html" }];
    drawDiagram(classes);
}
