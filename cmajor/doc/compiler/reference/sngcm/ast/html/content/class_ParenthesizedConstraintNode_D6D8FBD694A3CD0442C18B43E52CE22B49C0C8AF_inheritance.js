...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ParenthesizedConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ParenthesizedConstraintNode_D6D8FBD694A3CD0442C18B43E52CE22B49C0C8AF.html" }];
    drawDiagram(classes);
}
