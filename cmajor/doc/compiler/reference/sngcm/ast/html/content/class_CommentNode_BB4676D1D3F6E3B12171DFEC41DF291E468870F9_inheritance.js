...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::CommentNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CommentNode_BB4676D1D3F6E3B12171DFEC41DF291E468870F9.html" }];
    drawDiagram(classes);
}
