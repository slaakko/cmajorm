...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::RValueRefNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RValueRefNode_C57F91D51447ED914B6A7D40CE46F87E30B97A9C.html" }];
    drawDiagram(classes);
}
