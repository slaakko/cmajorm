...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::UCharLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_UCharLiteralNode_E151461595DEB25D751F273215D1AC16537CA9B7.html" }];
    drawDiagram(classes);
}
