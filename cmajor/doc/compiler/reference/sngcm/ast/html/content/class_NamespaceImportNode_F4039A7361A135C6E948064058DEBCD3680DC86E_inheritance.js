...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::NamespaceImportNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_NamespaceImportNode_F4039A7361A135C6E948064058DEBCD3680DC86E.html" }];
    drawDiagram(classes);
}
