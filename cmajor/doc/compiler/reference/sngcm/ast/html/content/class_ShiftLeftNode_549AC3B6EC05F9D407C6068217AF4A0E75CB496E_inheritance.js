...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ShiftLeftNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ShiftLeftNode_549AC3B6EC05F9D407C6068217AF4A0E75CB496E.html" }];
    drawDiagram(classes);
}
