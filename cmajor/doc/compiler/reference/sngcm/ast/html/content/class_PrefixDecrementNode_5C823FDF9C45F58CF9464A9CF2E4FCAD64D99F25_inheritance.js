...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::PrefixDecrementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PrefixDecrementNode_5C823FDF9C45F58CF9464A9CF2E4FCAD64D99F25.html" }];
    drawDiagram(classes);
}
