...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::AxiomStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AxiomStatementNode_DA9EE870715DB09AAA03EAC5C13883586486C0DE.html" }];
    drawDiagram(classes);
}
