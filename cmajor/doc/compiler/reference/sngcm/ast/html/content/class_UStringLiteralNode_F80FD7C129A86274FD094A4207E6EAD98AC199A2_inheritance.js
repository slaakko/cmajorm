...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::UStringLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_UStringLiteralNode_F80FD7C129A86274FD094A4207E6EAD98AC199A2.html" }];
    drawDiagram(classes);
}
