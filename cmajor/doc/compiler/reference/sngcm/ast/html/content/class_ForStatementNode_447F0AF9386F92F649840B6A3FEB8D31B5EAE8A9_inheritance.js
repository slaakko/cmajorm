...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ForStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ForStatementNode_447F0AF9386F92F649840B6A3FEB8D31B5EAE8A9.html" }];
    drawDiagram(classes);
}
