...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::AttributeNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AttributeNode_3773A18CCE422122F05FC15DC68E6FE8827EA37A.html" }];
    drawDiagram(classes);
}
