...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::StatementNode", id: "class_1", level: 1, subject: false, hasDerivedClasses: true, link: "./class_StatementNode_C645560C48648EE9245172CF4CA54D85381420E3.html" },
        { name: "sngcm::ast::ConditionalCompilationStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ConditionalCompilationStatementNode_4B98C381DE5E915EF5ED92CF39E226325697BF4E.html" }];
    drawDiagram(classes);
}
