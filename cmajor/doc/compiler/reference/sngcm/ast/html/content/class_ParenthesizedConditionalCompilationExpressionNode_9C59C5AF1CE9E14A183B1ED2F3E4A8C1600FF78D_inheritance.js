...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ParenthesizedConditionalCompilationExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ParenthesizedConditionalCompilationExpressionNode_9C59C5AF1CE9E14A183B1ED2F3E4A8C1600FF78D.html" }];
    drawDiagram(classes);
}
