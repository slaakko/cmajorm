...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConstantNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConstantNode_ECFC68B3CBE578FCC251D354EADA06ACC6A94A9E.html" }];
    drawDiagram(classes);
}
