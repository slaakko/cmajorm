...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConstructionStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ConstructionStatementNode_F0620C878B3D4A5922912EE438D93954AC92971A.html" }];
    drawDiagram(classes);
}
