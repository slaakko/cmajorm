...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::NamespaceNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_NamespaceNode_FCE3319C12CB53B9DE678E1E74EA6C7698B7CD4C.html" }];
    drawDiagram(classes);
}
