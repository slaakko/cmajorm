...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConditionalCompilationPrimaryNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ConditionalCompilationPrimaryNode_07E923476280F9B1A773646758E72E2755611A86.html" }];
    drawDiagram(classes);
}
