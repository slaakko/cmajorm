...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::BooleanLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_BooleanLiteralNode_BA061A8FA86B8477955DDB406C513FDEBAF71B8D.html" }];
    drawDiagram(classes);
}
