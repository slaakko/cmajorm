...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::MemberVariableNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_MemberVariableNode_C955E22C018764E831E18F3BD2F014BD4E19BA4A.html" }];
    drawDiagram(classes);
}
