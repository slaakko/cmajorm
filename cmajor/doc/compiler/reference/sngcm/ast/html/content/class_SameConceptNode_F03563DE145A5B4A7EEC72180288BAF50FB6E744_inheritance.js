...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::SameConceptNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_SameConceptNode_F03563DE145A5B4A7EEC72180288BAF50FB6E744.html" }];
    drawDiagram(classes);
}
