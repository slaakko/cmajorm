...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ShiftRightNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ShiftRightNode_63F766070D96F9070CEDB38563E78DBF492C73B3.html" }];
    drawDiagram(classes);
}
