...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConditionalCompilationPartNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConditionalCompilationPartNode_01E32244B3CCEB630093E6268978BAD22E17D2B7.html" }];
    drawDiagram(classes);
}
