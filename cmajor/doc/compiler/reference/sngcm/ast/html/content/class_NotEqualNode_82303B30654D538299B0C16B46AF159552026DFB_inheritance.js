...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::NotEqualNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NotEqualNode_82303B30654D538299B0C16B46AF159552026DFB.html" }];
    drawDiagram(classes);
}
