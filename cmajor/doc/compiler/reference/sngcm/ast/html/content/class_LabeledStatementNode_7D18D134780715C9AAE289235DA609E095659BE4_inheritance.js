...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::LabeledStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LabeledStatementNode_7D18D134780715C9AAE289235DA609E095659BE4.html" }];
    drawDiagram(classes);
}
