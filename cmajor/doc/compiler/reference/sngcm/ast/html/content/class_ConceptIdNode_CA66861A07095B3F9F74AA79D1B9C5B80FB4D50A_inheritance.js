...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::ConceptIdNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConceptIdNode_CA66861A07095B3F9F74AA79D1B9C5B80FB4D50A.html" }];
    drawDiagram(classes);
}
