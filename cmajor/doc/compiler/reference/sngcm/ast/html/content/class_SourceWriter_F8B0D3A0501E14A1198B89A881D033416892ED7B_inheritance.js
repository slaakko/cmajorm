...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::SourceWriter", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SourceWriter_F8B0D3A0501E14A1198B89A881D033416892ED7B.html" }];
    drawDiagram(classes);
}
