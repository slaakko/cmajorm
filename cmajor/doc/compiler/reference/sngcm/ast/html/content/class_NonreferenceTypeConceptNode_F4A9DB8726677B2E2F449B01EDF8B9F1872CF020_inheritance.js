...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcm::ast::NonreferenceTypeConceptNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NonreferenceTypeConceptNode_F4A9DB8726677B2E2F449B01EDF8B9F1872CF020.html" }];
    drawDiagram(classes);
}
