...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::PushProjectClientCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_PushProjectClientCommand_0BCA6C0EBC07CAF600941B64BC0A80293AFD8E9E.html" }];
    drawDiagram(classes);
}
