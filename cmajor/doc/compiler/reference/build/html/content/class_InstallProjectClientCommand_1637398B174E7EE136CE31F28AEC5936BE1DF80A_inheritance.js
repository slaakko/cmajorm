...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::InstallProjectClientCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InstallProjectClientCommand_1637398B174E7EE136CE31F28AEC5936BE1DF80A.html" }];
    drawDiagram(classes);
}
