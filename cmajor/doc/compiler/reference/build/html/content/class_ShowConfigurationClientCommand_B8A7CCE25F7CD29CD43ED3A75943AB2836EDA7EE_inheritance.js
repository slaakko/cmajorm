...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::build::ClientCommand", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_ClientCommand_30480C5C38CCBC5A6B75CCCA34F3E3787089333A.html" },
        { name: "cmajor::build::ShowConfigurationClientCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ShowConfigurationClientCommand_B8A7CCE25F7CD29CD43ED3A75943AB2836EDA7EE.html" }];
    drawDiagram(classes);
}
