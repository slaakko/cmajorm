...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::build::Log", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_Log_E5FAA7543B7619E2D8F0ECB72340AD71D694329D.html" },
        { name: "cmajor::build::CoutLog", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CoutLog_A84C3050565C1B9A3B888ABF92B83277114A1B46.html" }];
    drawDiagram(classes);
}
