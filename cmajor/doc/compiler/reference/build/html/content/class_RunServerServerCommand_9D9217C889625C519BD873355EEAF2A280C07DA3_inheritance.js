...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::RunServerServerCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RunServerServerCommand_9D9217C889625C519BD873355EEAF2A280C07DA3.html" }];
    drawDiagram(classes);
}
