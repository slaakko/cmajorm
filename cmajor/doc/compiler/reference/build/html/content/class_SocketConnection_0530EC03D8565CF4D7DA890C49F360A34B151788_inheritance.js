...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::build::Connection", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_Connection_6C90318ED52664031013E119C199EC38D4501BB9.html" },
        { name: "cmajor::build::SocketConnection", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SocketConnection_0530EC03D8565CF4D7DA890C49F360A34B151788.html" }];
    drawDiagram(classes);
}
