...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::RemoveProjectClientCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RemoveProjectClientCommand_3E949DF10ECD88946F31F80B35FEDA7B02D0F8FD.html" }];
    drawDiagram(classes);
}
