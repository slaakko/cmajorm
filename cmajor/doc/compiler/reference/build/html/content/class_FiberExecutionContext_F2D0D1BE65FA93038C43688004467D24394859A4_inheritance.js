...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::FiberExecutionContext", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FiberExecutionContext_F2D0D1BE65FA93038C43688004467D24394859A4.html" }];
    drawDiagram(classes);
}
