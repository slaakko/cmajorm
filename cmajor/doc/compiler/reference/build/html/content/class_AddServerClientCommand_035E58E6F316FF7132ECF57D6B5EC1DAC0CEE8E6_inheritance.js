...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::AddServerClientCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AddServerClientCommand_035E58E6F316FF7132ECF57D6B5EC1DAC0CEE8E6.html" }];
    drawDiagram(classes);
}
