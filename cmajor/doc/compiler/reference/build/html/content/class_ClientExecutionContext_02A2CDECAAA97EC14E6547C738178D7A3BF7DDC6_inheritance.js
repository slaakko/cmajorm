...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::ClientExecutionContext", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ClientExecutionContext_02A2CDECAAA97EC14E6547C738178D7A3BF7DDC6.html" }];
    drawDiagram(classes);
}
