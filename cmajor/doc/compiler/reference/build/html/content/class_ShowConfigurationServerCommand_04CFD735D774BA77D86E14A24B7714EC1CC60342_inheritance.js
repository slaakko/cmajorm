...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::build::ServerCommand", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_ServerCommand_287B051051506BC8C040C467E53D8F6ADB384C62.html" },
        { name: "cmajor::build::ShowConfigurationServerCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ShowConfigurationServerCommand_04CFD735D774BA77D86E14A24B7714EC1CC60342.html" }];
    drawDiagram(classes);
}
