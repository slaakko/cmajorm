...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::FiberClient", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FiberClient_61F6EDEA56725A68E3ED9F6B8DF07CCE9C00163C.html" }];
    drawDiagram(classes);
}
