...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::FiberConnection", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FiberConnection_D742502AF943DDAD23C56A8E1EC303DD3FF1291E.html" }];
    drawDiagram(classes);
}
