...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::Requester", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_Requester_FBCA70AD3F0FE39012DDA24090B0133B9466D50E.html" }];
    drawDiagram(classes);
}
