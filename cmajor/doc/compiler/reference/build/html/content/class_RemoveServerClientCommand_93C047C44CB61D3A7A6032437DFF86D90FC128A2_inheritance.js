...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::RemoveServerClientCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RemoveServerClientCommand_93C047C44CB61D3A7A6032437DFF86D90FC128A2.html" }];
    drawDiagram(classes);
}
