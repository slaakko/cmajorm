...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::SocketServer", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SocketServer_21A5F3B5892FFB777821173C76023CBA81847CBB.html" }];
    drawDiagram(classes);
}
