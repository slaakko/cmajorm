...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::build::Host", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_Host_E94AA38A88E5E5A14022F010D55F30332CE31433.html" },
        { name: "cmajor::build::SocketClient", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SocketClient_FB7687ED7FF1DA6F74B83864433A0AC7681D7CC8.html" }];
    drawDiagram(classes);
}
