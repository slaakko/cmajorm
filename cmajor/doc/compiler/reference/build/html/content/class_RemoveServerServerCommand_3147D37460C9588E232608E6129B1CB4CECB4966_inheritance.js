...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::RemoveServerServerCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RemoveServerServerCommand_3147D37460C9588E232608E6129B1CB4CECB4966.html" }];
    drawDiagram(classes);
}
