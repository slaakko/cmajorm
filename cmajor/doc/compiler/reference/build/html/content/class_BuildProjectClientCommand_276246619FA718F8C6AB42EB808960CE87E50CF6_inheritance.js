...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::BuildProjectClientCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BuildProjectClientCommand_276246619FA718F8C6AB42EB808960CE87E50CF6.html" }];
    drawDiagram(classes);
}
