...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::build::MessageHandler", id: "class_0", level: 0, subject: true, hasDerivedClasses: true, link: "./class_MessageHandler_564D7BFA33CB0E8DB0E008DEC634D73AFCC6A15B.html" },
        { name: "cmajor::build::RequestHandler", id: "class_1", level: 1, subject: false, hasDerivedClasses: false, link: "./class_RequestHandler_88094A770C306BF8DEBF282736426F720F47C58D.html" },
        { name: "cmajor::build::Requester", id: "class_2", level: 1, subject: false, hasDerivedClasses: false, link: "./class_Requester_FBCA70AD3F0FE39012DDA24090B0133B9466D50E.html" }];
    drawDiagram(classes);
}
