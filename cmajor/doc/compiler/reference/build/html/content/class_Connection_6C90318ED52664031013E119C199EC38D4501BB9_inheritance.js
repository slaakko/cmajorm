...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::build::Connection", id: "class_0", level: 0, subject: true, hasDerivedClasses: true, link: "./class_Connection_6C90318ED52664031013E119C199EC38D4501BB9.html" },
        { name: "cmajor::build::FiberConnection", id: "class_1", level: 1, subject: false, hasDerivedClasses: false, link: "./class_FiberConnection_D742502AF943DDAD23C56A8E1EC303DD3FF1291E.html" },
        { name: "cmajor::build::SocketConnection", id: "class_2", level: 1, subject: false, hasDerivedClasses: false, link: "./class_SocketConnection_0530EC03D8565CF4D7DA890C49F360A34B151788.html" }];
    drawDiagram(classes);
}
