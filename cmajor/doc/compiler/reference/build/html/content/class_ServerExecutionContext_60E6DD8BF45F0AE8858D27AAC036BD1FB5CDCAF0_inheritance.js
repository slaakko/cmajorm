...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::build::ExecutionContext", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_ExecutionContext_27100B5CEBAD09C81C15C26C3882D2F1A04E81FD.html" },
        { name: "cmajor::build::ServerExecutionContext", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ServerExecutionContext_60E6DD8BF45F0AE8858D27AAC036BD1FB5CDCAF0.html" }];
    drawDiagram(classes);
}
