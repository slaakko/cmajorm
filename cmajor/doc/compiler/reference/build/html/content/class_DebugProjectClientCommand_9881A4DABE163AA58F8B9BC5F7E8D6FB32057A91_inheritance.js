...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::DebugProjectClientCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebugProjectClientCommand_9881A4DABE163AA58F8B9BC5F7E8D6FB32057A91.html" }];
    drawDiagram(classes);
}
