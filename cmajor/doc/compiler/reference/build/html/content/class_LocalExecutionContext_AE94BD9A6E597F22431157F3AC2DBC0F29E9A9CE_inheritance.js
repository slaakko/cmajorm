...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::build::LocalExecutionContext", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LocalExecutionContext_AE94BD9A6E597F22431157F3AC2DBC0F29E9A9CE.html" }];
    drawDiagram(classes);
}
