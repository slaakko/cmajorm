...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::StructureValue", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_StructureValue_7F567A38AF443771F0C6A9921294722C6570616C.html" }];
    drawDiagram(classes);
}
