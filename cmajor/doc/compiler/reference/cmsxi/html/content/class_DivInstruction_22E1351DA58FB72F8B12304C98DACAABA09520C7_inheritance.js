...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::DivInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_DivInstruction_22E1351DA58FB72F8B12304C98DACAABA09520C7.html" }];
    drawDiagram(classes);
}
