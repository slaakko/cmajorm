...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::CallInstruction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CallInstruction_05DFC938BEF33F80DF5A0D72730A2DB3E32255F6.html" }];
    drawDiagram(classes);
}
