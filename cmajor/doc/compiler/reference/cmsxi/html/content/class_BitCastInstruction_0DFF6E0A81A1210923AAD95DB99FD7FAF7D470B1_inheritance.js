...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::BitCastInstruction", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_BitCastInstruction_0DFF6E0A81A1210923AAD95DB99FD7FAF7D470B1.html" }];
    drawDiagram(classes);
}
