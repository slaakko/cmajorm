...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::TruncateInstruction", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_TruncateInstruction_40D88B28279B6C2C2D50EF565154142D56FCAF8F.html" }];
    drawDiagram(classes);
}
