...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::StoreInstruction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_StoreInstruction_C8901B05E1AB70FF53FF3EA5295EF93CDA7F5BF4.html" }];
    drawDiagram(classes);
}
