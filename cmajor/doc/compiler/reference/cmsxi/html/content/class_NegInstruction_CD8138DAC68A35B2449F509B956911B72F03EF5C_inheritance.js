...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::NegInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_NegInstruction_CD8138DAC68A35B2449F509B956911B72F03EF5C.html" }];
    drawDiagram(classes);
}
