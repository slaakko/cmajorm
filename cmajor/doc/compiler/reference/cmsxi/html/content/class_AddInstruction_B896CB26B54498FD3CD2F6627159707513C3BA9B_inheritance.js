...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::AddInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_AddInstruction_B896CB26B54498FD3CD2F6627159707513C3BA9B.html" }];
    drawDiagram(classes);
}
