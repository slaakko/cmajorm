...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::MulInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_MulInstruction_385E64231399E604A0A022C94F432917FAABE8B6.html" }];
    drawDiagram(classes);
}
