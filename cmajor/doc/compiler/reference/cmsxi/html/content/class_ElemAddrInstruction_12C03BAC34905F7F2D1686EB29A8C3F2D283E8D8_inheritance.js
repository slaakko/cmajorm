...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::ElemAddrInstruction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ElemAddrInstruction_12C03BAC34905F7F2D1686EB29A8C3F2D283E8D8.html" }];
    drawDiagram(classes);
}
