...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::ModInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ModInstruction_264D2AE4501840CF6733DF09B693A11F7B21DD4A.html" }];
    drawDiagram(classes);
}
