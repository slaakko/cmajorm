...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::IntToPtrInstruction", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_IntToPtrInstruction_8EF26A3BD257052B1A7D9FED9B22F1E73E9ACBD6.html" }];
    drawDiagram(classes);
}
