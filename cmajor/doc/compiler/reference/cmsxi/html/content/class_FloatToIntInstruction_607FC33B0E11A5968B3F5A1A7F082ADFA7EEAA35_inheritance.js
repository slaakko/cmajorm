...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::UnaryTypeInstruction", id: "class_3", level: 3, subject: false, hasDerivedClasses: true, link: "./class_UnaryTypeInstruction_948AFA74E57FF63A97888C866740339252D579D7.html" },
        { name: "cmsxi::FloatToIntInstruction", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_FloatToIntInstruction_607FC33B0E11A5968B3F5A1A7F082ADFA7EEAA35.html" }];
    drawDiagram(classes);
}
