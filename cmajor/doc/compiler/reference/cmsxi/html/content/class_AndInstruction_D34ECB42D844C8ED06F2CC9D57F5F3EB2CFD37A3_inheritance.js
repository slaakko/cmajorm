...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::AndInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_AndInstruction_D34ECB42D844C8ED06F2CC9D57F5F3EB2CFD37A3.html" }];
    drawDiagram(classes);
}
