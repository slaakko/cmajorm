...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::ParamInstruction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ParamInstruction_4282832B48B8DA9D0154354509D63C3D92EB42BC.html" }];
    drawDiagram(classes);
}
