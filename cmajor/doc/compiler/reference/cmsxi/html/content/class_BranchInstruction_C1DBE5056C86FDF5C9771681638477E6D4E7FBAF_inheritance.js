...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::BranchInstruction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_BranchInstruction_C1DBE5056C86FDF5C9771681638477E6D4E7FBAF.html" }];
    drawDiagram(classes);
}
