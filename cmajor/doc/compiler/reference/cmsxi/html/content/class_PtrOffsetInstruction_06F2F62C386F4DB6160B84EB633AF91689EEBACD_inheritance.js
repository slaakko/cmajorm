...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::PtrOffsetInstruction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PtrOffsetInstruction_06F2F62C386F4DB6160B84EB633AF91689EEBACD.html" }];
    drawDiagram(classes);
}
