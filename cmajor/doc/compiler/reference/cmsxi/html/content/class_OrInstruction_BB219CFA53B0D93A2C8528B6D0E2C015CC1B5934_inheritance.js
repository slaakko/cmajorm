...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::OrInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_OrInstruction_BB219CFA53B0D93A2C8528B6D0E2C015CC1B5934.html" }];
    drawDiagram(classes);
}
