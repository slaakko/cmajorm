...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::ArgInstruction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ArgInstruction_8D66ACB96862655F3B1B9EECCF791EFF8DB03611.html" }];
    drawDiagram(classes);
}
