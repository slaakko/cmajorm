...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::SubInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_SubInstruction_80215F458791800ACC8DB084A5425D9D25BA9C95.html" }];
    drawDiagram(classes);
}
