...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::XorInstruction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_XorInstruction_9B79D9ACAF78F8CBDCA4F8CFCA4818429240DB67.html" }];
    drawDiagram(classes);
}
