...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::GlobalVariable", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GlobalVariable_3BA6B03F2CA7C35790FBAF75A9C5B513C3EBCA31.html" }];
    drawDiagram(classes);
}
