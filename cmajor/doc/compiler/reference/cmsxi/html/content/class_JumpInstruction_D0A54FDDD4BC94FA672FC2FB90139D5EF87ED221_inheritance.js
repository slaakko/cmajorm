...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::JumpInstruction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_JumpInstruction_D0A54FDDD4BC94FA672FC2FB90139D5EF87ED221.html" }];
    drawDiagram(classes);
}
