...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmsxi::ZeroExtendInstruction", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_ZeroExtendInstruction_7DEF2EC4307FB862162484B59B57236F9B59BD3C.html" }];
    drawDiagram(classes);
}
