...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerEqualOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_PointerEqualOperation_59FB10164E51F1F94791760134FD8D797986BE6A.html" }];
    drawDiagram(classes);
}
