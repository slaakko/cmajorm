...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::InterfaceMoveConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InterfaceMoveConstructorOperation_193A1C5024C8C9401732D16575CD0BBC14CE904E.html" }];
    drawDiagram(classes);
}
