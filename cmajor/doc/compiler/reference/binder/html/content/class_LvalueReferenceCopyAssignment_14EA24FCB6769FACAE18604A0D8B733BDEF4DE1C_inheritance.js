...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::LvalueReferenceCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_LvalueReferenceCopyAssignment_14EA24FCB6769FACAE18604A0D8B733BDEF4DE1C.html" }];
    drawDiagram(classes);
}
