...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerCopyCtor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PointerCopyCtor_0078845CB37880EA9A208EED0C190084141E6447.html" }];
    drawDiagram(classes);
}
