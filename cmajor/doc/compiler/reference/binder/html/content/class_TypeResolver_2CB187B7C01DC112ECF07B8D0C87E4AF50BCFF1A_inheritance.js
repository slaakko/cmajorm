...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::TypeResolver", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TypeResolver_2CB187B7C01DC112ECF07B8D0C87E4AF50BCFF1A.html" }];
    drawDiagram(classes);
}
