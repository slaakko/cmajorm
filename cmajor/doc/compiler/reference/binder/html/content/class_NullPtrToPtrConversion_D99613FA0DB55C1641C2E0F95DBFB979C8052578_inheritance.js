...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::NullPtrToPtrConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_NullPtrToPtrConversion_D99613FA0DB55C1641C2E0F95DBFB979C8052578.html" }];
    drawDiagram(classes);
}
