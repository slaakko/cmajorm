...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerArrow", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PointerArrow_7B7DC29B0DBABE835E83B2063406AFF47B5B6574.html" }];
    drawDiagram(classes);
}
