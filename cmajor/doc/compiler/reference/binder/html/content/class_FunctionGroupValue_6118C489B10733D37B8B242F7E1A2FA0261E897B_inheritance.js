...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::FunctionGroupValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FunctionGroupValue_6118C489B10733D37B8B242F7E1A2FA0261E897B.html" }];
    drawDiagram(classes);
}
