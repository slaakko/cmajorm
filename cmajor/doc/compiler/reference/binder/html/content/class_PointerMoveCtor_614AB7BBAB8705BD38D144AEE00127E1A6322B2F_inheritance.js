...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerMoveCtor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PointerMoveCtor_614AB7BBAB8705BD38D144AEE00127E1A6322B2F.html" }];
    drawDiagram(classes);
}
