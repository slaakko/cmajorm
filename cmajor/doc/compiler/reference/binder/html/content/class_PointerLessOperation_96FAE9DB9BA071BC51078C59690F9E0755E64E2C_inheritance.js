...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerLessOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_PointerLessOperation_96FAE9DB9BA071BC51078C59690F9E0755E64E2C.html" }];
    drawDiagram(classes);
}
