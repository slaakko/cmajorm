...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ScopedValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ScopedValue_2C3ED81E6D73F2BE376CBEB734E95048BE78A48C.html" }];
    drawDiagram(classes);
}
