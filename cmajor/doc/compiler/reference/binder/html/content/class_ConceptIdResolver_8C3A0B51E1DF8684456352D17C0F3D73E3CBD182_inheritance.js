...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ConceptIdResolver", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConceptIdResolver_8C3A0B51E1DF8684456352D17C0F3D73E3CBD182.html" }];
    drawDiagram(classes);
}
