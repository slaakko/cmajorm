...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::LvalueReferenceReturn", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_LvalueReferenceReturn_BF7AB55DC4BA8B370928E511DD2D025597421C41.html" }];
    drawDiagram(classes);
}
