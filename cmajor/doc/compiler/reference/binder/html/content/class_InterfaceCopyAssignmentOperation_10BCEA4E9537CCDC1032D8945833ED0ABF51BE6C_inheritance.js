...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::InterfaceCopyAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InterfaceCopyAssignmentOperation_10BCEA4E9537CCDC1032D8945833ED0ABF51BE6C.html" }];
    drawDiagram(classes);
}
