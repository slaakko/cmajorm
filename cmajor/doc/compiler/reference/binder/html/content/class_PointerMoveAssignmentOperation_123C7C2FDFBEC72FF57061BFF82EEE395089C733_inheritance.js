...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerMoveAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_PointerMoveAssignmentOperation_123C7C2FDFBEC72FF57061BFF82EEE395089C733.html" }];
    drawDiagram(classes);
}
