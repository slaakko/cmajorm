...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ControlFlowAnalyzer", id: "class_1", level: 1, subject: false, hasDerivedClasses: false, link: "./class_ControlFlowAnalyzer_3FCB421729E3D744CC480D8E995DAEB945EB8AEA.html" }];
    drawDiagram(classes);
}
