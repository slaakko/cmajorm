...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ArrayCopyAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ArrayCopyAssignmentOperation_D43AC3E8A433DB1155DFB4CE6FB20EA20C338450.html" }];
    drawDiagram(classes);
}
