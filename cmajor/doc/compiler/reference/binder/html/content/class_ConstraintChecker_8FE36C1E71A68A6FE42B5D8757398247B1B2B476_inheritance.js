...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ConstraintChecker", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConstraintChecker_8FE36C1E71A68A6FE42B5D8757398247B1B2B476.html" }];
    drawDiagram(classes);
}
