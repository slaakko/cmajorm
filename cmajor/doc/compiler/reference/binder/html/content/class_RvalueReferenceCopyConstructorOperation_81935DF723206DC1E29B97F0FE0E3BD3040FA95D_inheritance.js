...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::RvalueReferenceCopyConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RvalueReferenceCopyConstructorOperation_81935DF723206DC1E29B97F0FE0E3BD3040FA95D.html" }];
    drawDiagram(classes);
}
