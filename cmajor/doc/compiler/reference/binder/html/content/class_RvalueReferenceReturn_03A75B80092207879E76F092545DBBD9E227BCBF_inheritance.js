...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::RvalueReferenceReturn", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_RvalueReferenceReturn_03A75B80092207879E76F092545DBBD9E227BCBF.html" }];
    drawDiagram(classes);
}
