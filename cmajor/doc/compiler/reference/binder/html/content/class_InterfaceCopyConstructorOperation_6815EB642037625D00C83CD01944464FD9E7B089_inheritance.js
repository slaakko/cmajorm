...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::InterfaceCopyConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InterfaceCopyConstructorOperation_6815EB642037625D00C83CD01944464FD9E7B089.html" }];
    drawDiagram(classes);
}
