...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ArrayMoveConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ArrayMoveConstructorOperation_E90CFDC3537B79C26FE803C9A6B5E7A09C10C2E5.html" }];
    drawDiagram(classes);
}
