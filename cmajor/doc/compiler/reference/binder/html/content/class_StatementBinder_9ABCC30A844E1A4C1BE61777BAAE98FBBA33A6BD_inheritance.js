...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::StatementBinder", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_StatementBinder_9ABCC30A844E1A4C1BE61777BAAE98FBBA33A6BD.html" }];
    drawDiagram(classes);
}
