...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::TypeBinder", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TypeBinder_197D6C7822958FE5DD6F6B43DDE787A9FA490EEA.html" }];
    drawDiagram(classes);
}
