...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::RvalueReferenceReturnOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RvalueReferenceReturnOperation_ACA3C3AAFD230DB6127171EFA7140119E090DCB8.html" }];
    drawDiagram(classes);
}
