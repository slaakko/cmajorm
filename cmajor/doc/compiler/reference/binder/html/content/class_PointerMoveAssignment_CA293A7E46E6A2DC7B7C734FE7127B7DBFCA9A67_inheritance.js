...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerMoveAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PointerMoveAssignment_CA293A7E46E6A2DC7B7C734FE7127B7DBFCA9A67.html" }];
    drawDiagram(classes);
}
