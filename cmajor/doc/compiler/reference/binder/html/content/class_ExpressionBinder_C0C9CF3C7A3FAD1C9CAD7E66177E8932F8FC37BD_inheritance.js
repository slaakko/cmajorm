...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ExpressionBinder", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ExpressionBinder_C0C9CF3C7A3FAD1C9CAD7E66177E8932F8FC37BD.html" }];
    drawDiagram(classes);
}
