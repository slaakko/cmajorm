...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ClassCopyAssignment", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_ClassCopyAssignment_695FAD013F84B575305311A0FF51B2EA299A4E07.html" }];
    drawDiagram(classes);
}
