...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PtrToULongConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PtrToULongConversion_5B3BF45C6E9A6C79BEFC80A4CDFBD2D78974ECD7.html" }];
    drawDiagram(classes);
}
