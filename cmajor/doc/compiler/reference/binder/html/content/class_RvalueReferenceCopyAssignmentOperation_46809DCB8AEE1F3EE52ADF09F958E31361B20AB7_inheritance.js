...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::RvalueReferenceCopyAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RvalueReferenceCopyAssignmentOperation_46809DCB8AEE1F3EE52ADF09F958E31361B20AB7.html" }];
    drawDiagram(classes);
}
