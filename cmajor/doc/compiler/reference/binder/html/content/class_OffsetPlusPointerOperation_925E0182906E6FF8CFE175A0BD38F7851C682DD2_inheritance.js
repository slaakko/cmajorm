...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::OffsetPlusPointerOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_OffsetPlusPointerOperation_925E0182906E6FF8CFE175A0BD38F7851C682DD2.html" }];
    drawDiagram(classes);
}
