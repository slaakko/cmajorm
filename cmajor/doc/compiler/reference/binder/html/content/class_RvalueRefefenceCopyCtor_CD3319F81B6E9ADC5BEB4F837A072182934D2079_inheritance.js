...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::RvalueRefefenceCopyCtor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_RvalueRefefenceCopyCtor_CD3319F81B6E9ADC5BEB4F837A072182934D2079.html" }];
    drawDiagram(classes);
}
