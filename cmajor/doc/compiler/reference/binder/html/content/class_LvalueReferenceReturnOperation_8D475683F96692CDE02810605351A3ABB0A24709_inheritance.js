...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::LvalueReferenceReturnOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LvalueReferenceReturnOperation_8D475683F96692CDE02810605351A3ABB0A24709.html" }];
    drawDiagram(classes);
}
