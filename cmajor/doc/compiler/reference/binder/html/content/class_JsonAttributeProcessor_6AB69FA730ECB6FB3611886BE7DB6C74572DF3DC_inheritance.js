...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::JsonAttributeProcessor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_JsonAttributeProcessor_6AB69FA730ECB6FB3611886BE7DB6C74572DF3DC.html" }];
    drawDiagram(classes);
}
