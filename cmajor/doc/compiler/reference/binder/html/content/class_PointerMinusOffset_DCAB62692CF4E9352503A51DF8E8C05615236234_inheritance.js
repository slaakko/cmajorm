...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerMinusOffset", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PointerMinusOffset_DCAB62692CF4E9352503A51DF8E8C05615236234.html" }];
    drawDiagram(classes);
}
