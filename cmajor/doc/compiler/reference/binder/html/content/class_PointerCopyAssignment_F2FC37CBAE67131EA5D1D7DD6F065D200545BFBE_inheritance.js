...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PointerCopyAssignment_F2FC37CBAE67131EA5D1D7DD6F065D200545BFBE.html" }];
    drawDiagram(classes);
}
