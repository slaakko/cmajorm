...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PtrToVoidPtrConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PtrToVoidPtrConversion_361DA30B5605F0C014309EAA0C906E6D427A2098.html" }];
    drawDiagram(classes);
}
