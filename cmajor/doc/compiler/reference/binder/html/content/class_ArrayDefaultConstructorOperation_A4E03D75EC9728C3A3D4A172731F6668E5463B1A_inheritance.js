...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ArrayDefaultConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ArrayDefaultConstructorOperation_A4E03D75EC9728C3A3D4A172731F6668E5463B1A.html" }];
    drawDiagram(classes);
}
