...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ClassMoveConstructor", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_ClassMoveConstructor_E5FF820FABA6A4F46865FCCCC20941ACF9083A29.html" }];
    drawDiagram(classes);
}
