...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::LvalueReferenceMoveAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_LvalueReferenceMoveAssignment_BFF134D80251F37071073623C42A01A6B6528EF1.html" }];
    drawDiagram(classes);
}
