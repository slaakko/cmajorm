...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::StringReferenceValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_StringReferenceValue_057878D9762CE1EC152C4E059E61FE4329289BFB.html" }];
    drawDiagram(classes);
}
