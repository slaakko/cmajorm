...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::RvalueReferenceCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_RvalueReferenceCopyAssignment_874601339549249CD5ABB51ABDF5AACF255EC712.html" }];
    drawDiagram(classes);
}
