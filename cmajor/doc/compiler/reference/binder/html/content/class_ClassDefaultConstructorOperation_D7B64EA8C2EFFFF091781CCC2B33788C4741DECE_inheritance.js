...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ClassDefaultConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ClassDefaultConstructorOperation_D7B64EA8C2EFFFF091781CCC2B33788C4741DECE.html" }];
    drawDiagram(classes);
}
