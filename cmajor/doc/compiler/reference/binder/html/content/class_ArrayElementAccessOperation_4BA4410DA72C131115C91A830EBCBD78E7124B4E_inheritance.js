...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ArrayElementAccessOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ArrayElementAccessOperation_4BA4410DA72C131115C91A830EBCBD78E7124B4E.html" }];
    drawDiagram(classes);
}
