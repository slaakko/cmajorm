...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::LvalueReferenceMoveAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LvalueReferenceMoveAssignmentOperation_33B267AC218893F356C0FCF202AB1842E97F3926.html" }];
    drawDiagram(classes);
}
