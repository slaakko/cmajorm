...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::binder::AttributeProcessor", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_AttributeProcessor_0A91371F1E463526CB54EFCCF1D80DDB8AC06CF7.html" },
        { name: "cmajor::binder::SystemDefaultAttributeProcessor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SystemDefaultAttributeProcessor_339180FFDFC7DB48444E2C859DBBA5B5A061DADB.html" }];
    drawDiagram(classes);
}
