...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::LvalueRefefenceCopyCtor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_LvalueRefefenceCopyCtor_05022231F688EFA85AAB88B025F6427A2C54B13B.html" }];
    drawDiagram(classes);
}
