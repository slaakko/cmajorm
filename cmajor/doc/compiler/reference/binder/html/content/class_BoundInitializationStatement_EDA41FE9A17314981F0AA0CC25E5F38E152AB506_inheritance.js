...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundInitializationStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_BoundInitializationStatement_EDA41FE9A17314981F0AA0CC25E5F38E152AB506.html" }];
    drawDiagram(classes);
}
