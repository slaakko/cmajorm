...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerDefaultConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_PointerDefaultConstructorOperation_5380052011E0AA919DA1E6E83F6095BC2DBA0D56.html" }];
    drawDiagram(classes);
}
