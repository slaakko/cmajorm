...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ClassCopyConstructor", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_ClassCopyConstructor_AA2BA58A6B4E8B7F11EFD338B34003F9B22D399C.html" }];
    drawDiagram(classes);
}
