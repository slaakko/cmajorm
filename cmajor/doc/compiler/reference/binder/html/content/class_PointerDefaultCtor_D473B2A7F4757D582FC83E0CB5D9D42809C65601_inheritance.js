...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerDefaultCtor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PointerDefaultCtor_D473B2A7F4757D582FC83E0CB5D9D42809C65601.html" }];
    drawDiagram(classes);
}
