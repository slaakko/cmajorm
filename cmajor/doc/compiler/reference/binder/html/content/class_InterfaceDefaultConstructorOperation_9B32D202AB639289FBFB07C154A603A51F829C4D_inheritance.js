...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::InterfaceDefaultConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InterfaceDefaultConstructorOperation_9B32D202AB639289FBFB07C154A603A51F829C4D.html" }];
    drawDiagram(classes);
}
