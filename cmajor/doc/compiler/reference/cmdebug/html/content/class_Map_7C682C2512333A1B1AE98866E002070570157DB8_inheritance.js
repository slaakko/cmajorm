...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::TreeContainer", id: "class_2", level: 2, subject: false, hasDerivedClasses: true, link: "./class_TreeContainer_C8561EBE6BF1D0BF286176BC566408BE85EA50A2.html" },
        { name: "cmajor::debug::Map", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_Map_7C682C2512333A1B1AE98866E002070570157DB8.html" }];
    drawDiagram(classes);
}
