...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerUntilCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerUntilCommand_B61B8FAFBA7C50DD748FB035EE793DB352B0B2C6.html" }];
    drawDiagram(classes);
}
