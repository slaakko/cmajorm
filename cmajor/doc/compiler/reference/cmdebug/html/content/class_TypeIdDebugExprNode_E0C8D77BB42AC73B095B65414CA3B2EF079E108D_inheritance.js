...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::TypeIdDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TypeIdDebugExprNode_E0C8D77BB42AC73B095B65414CA3B2EF079E108D.html" }];
    drawDiagram(classes);
}
