...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbErrorRecord", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GdbErrorRecord_07756CB22DF2E697CF701311406FC4760FDD321C.html" }];
    drawDiagram(classes);
}
