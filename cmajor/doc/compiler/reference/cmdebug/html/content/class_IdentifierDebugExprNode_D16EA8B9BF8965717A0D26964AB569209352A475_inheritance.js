...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::IdentifierDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_IdentifierDebugExprNode_D16EA8B9BF8965717A0D26964AB569209352A475.html" }];
    drawDiagram(classes);
}
