...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarDeleteCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarDeleteCommand_1A46592C8C49C16C892FC166F62D2D467BB86F19.html" }];
    drawDiagram(classes);
}
