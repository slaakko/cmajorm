...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbResult", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbResult_AD735AFDC525C867FFFCC22A3C61ACC71A5747A4.html" }];
    drawDiagram(classes);
}
