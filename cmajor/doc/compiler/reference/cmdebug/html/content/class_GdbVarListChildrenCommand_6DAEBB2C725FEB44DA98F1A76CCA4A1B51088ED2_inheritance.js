...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarListChildrenCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarListChildrenCommand_6DAEBB2C725FEB44DA98F1A76CCA4A1B51088ED2.html" }];
    drawDiagram(classes);
}
