...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DIDelegateType", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DIDelegateType_2326089BD69C802C2CE393E40F90DAD4649AF652.html" }];
    drawDiagram(classes);
}
