...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarUpdateCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarUpdateCommand_F8E1BF748754774DCE8ED11B3BE0A0198AA5FF60.html" }];
    drawDiagram(classes);
}
