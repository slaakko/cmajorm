...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::RangeDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RangeDebugExprNode_7903853BBB12547CBC8AC2B62D5F5BB117DFCFD1.html" }];
    drawDiagram(classes);
}
