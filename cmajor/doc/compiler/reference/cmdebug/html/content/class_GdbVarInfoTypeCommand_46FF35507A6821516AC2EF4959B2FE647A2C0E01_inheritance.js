...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarInfoTypeCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarInfoTypeCommand_46FF35507A6821516AC2EF4959B2FE647A2C0E01.html" }];
    drawDiagram(classes);
}
