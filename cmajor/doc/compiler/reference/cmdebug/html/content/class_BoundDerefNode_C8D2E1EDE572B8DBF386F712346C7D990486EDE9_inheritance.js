...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundDerefNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundDerefNode_C8D2E1EDE572B8DBF386F712346C7D990486EDE9.html" }];
    drawDiagram(classes);
}
