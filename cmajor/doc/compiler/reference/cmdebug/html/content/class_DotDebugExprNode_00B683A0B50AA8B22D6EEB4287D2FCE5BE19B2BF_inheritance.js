...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DotDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DotDebugExprNode_00B683A0B50AA8B22D6EEB4287D2FCE5BE19B2BF.html" }];
    drawDiagram(classes);
}
