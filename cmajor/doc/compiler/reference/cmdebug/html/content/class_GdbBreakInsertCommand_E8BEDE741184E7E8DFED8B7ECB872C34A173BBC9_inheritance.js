...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbBreakInsertCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbBreakInsertCommand_E8BEDE741184E7E8DFED8B7ECB872C34A173BBC9.html" }];
    drawDiagram(classes);
}
