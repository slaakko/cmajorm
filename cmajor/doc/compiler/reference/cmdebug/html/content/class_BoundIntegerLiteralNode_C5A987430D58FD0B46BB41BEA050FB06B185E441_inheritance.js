...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundIntegerLiteralNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundIntegerLiteralNode_C5A987430D58FD0B46BB41BEA050FB06B185E441.html" }];
    drawDiagram(classes);
}
