...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundDebugExpression", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundDebugExpression_7BC69B4A9A487081E71C9EC628FB8E6A0E325E17.html" }];
    drawDiagram(classes);
}
