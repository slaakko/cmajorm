...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbRunningRecord", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GdbRunningRecord_B9B221FCB643407E48A4E7C758257C696B243E7E.html" }];
    drawDiagram(classes);
}
