...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExecRunningRecord", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_GdbExecRunningRecord_3C86736B8334A0FFCE6ACEBFAAA93082E129C1CA.html" }];
    drawDiagram(classes);
}
