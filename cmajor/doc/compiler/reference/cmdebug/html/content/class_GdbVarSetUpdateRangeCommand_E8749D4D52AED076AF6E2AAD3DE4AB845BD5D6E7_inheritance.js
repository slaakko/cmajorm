...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarSetUpdateRangeCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarSetUpdateRangeCommand_E8749D4D52AED076AF6E2AAD3DE4AB845BD5D6E7.html" }];
    drawDiagram(classes);
}
