...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DerefDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DerefDebugExprNode_44972610CC26A5DDD1BFABB3FAAB1CEE3F89DE2A.html" }];
    drawDiagram(classes);
}
