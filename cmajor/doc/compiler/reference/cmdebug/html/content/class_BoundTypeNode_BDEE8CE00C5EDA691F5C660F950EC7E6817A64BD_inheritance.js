...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundTypeNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundTypeNode_BDEE8CE00C5EDA691F5C660F950EC7E6817A64BD.html" }];
    drawDiagram(classes);
}
