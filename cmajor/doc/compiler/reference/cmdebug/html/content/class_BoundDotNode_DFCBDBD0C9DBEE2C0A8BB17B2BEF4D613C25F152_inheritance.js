...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundDotNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundDotNode_DFCBDBD0C9DBEE2C0A8BB17B2BEF4D613C25F152.html" }];
    drawDiagram(classes);
}
