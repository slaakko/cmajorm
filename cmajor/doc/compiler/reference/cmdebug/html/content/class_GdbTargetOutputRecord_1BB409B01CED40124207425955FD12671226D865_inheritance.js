...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbTargetOutputRecord", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GdbTargetOutputRecord_1BB409B01CED40124207425955FD12671226D865.html" }];
    drawDiagram(classes);
}
