...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerShowBreakpointCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerShowBreakpointCommand_AEBECAA0C88AC9547AC7A69E1890E04BB350CE82.html" }];
    drawDiagram(classes);
}
