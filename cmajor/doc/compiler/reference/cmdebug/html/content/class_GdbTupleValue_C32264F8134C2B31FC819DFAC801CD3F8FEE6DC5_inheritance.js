...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbTupleValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbTupleValue_C32264F8134C2B31FC819DFAC801CD3F8FEE6DC5.html" }];
    drawDiagram(classes);
}
