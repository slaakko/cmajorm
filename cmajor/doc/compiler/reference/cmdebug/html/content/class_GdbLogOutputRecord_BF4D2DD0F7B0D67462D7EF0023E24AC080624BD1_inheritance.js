...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbLogOutputRecord", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GdbLogOutputRecord_BF4D2DD0F7B0D67462D7EF0023E24AC080624BD1.html" }];
    drawDiagram(classes);
}
