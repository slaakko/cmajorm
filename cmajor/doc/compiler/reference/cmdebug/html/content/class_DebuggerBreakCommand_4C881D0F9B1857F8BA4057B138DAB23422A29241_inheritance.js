...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerBreakCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerBreakCommand_4C881D0F9B1857F8BA4057B138DAB23422A29241.html" }];
    drawDiagram(classes);
}
