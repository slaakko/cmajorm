...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExecContinueCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbExecContinueCommand_DFFC95D76ACBEDA65557A171C199E5A67EF1C16D.html" }];
    drawDiagram(classes);
}
