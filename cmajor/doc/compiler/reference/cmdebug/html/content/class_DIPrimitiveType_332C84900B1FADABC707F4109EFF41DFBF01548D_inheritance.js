...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DIPrimitiveType", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DIPrimitiveType_332C84900B1FADABC707F4109EFF41DFBF01548D.html" }];
    drawDiagram(classes);
}
