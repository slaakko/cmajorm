...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DITemplateParameter", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DITemplateParameter_E1119E351556F087CE6A5DA21A116EF4F29C01B0.html" }];
    drawDiagram(classes);
}
