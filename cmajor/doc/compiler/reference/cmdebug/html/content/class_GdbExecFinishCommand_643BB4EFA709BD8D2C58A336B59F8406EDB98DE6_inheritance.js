...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExecFinishCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbExecFinishCommand_643BB4EFA709BD8D2C58A336B59F8406EDB98DE6.html" }];
    drawDiagram(classes);
}
