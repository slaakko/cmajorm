...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerNextCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerNextCommand_EEAED2AD20DFC2D68C43472F47AF4FD0404AA24E.html" }];
    drawDiagram(classes);
}
