...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerPrintCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerPrintCommand_EC3C0ED24806EE676217E5DF64FD666384EB96C3.html" }];
    drawDiagram(classes);
}
