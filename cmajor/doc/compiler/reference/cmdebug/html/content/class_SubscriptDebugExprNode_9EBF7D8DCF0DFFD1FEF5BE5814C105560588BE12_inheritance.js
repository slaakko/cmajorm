...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::SubscriptDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SubscriptDebugExprNode_9EBF7D8DCF0DFFD1FEF5BE5814C105560588BE12.html" }];
    drawDiagram(classes);
}
