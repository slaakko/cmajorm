...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarSetFormatCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarSetFormatCommand_87AC7C0B0275F4B73F8642FAE1126CC21B9EBFE2.html" }];
    drawDiagram(classes);
}
