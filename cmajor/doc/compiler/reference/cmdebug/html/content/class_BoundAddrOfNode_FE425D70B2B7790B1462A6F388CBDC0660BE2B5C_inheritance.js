...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundAddrOfNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundAddrOfNode_FE425D70B2B7790B1462A6F388CBDC0660BE2B5C.html" }];
    drawDiagram(classes);
}
