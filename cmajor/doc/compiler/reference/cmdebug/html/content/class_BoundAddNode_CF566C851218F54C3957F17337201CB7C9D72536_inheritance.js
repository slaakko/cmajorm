...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundAddNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundAddNode_CF566C851218F54C3957F17337201CB7C9D72536.html" }];
    drawDiagram(classes);
}
