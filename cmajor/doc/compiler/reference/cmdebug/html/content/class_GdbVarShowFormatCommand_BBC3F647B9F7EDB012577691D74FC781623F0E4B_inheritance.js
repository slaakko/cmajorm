...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarShowFormatCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarShowFormatCommand_BBC3F647B9F7EDB012577691D74FC781623F0E4B.html" }];
    drawDiagram(classes);
}
