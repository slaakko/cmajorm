...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarSetVisualizerCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarSetVisualizerCommand_937F07A406162485E75A743ECE4FAE9904A696FF.html" }];
    drawDiagram(classes);
}
