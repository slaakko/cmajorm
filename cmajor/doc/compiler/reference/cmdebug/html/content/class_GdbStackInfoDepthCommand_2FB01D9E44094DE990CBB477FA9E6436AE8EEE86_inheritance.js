...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbStackInfoDepthCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbStackInfoDepthCommand_2FB01D9E44094DE990CBB477FA9E6436AE8EEE86.html" }];
    drawDiagram(classes);
}
