...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerFinishCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerFinishCommand_B69DCABD7D5DE99C9B3EF0EB8EFB2ED73D8C847E.html" }];
    drawDiagram(classes);
}
