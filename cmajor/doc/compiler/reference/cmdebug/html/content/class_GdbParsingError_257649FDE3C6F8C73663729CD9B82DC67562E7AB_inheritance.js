...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbParsingError", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbParsingError_257649FDE3C6F8C73663729CD9B82DC67562E7AB.html" }];
    drawDiagram(classes);
}
