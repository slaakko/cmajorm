...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarCreateCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarCreateCommand_E5E81C566823A74CBCCC8882B7761402C5CD94D1.html" }];
    drawDiagram(classes);
}
