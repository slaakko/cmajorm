...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbBreakDeleteCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbBreakDeleteCommand_6410447CA8165BE280CD9694D14CB0AD87244500.html" }];
    drawDiagram(classes);
}
