...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbDoneRecord", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GdbDoneRecord_BD9FE28F43C771699A4A56041622E074A5F34CCA.html" }];
    drawDiagram(classes);
}
