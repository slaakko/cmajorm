...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundCastNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundCastNode_B6E3DAB95A1D1C31A3958026C3E76E6F78B50EF2.html" }];
    drawDiagram(classes);
}
