...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerDepthCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerDepthCommand_3B444A29F9B448CC315B5AA84FCD1D912D7D00AB.html" }];
    drawDiagram(classes);
}
