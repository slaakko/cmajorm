...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExecStepCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbExecStepCommand_50A56813B8C838FBA0E68E657780E92BA2EB1C96.html" }];
    drawDiagram(classes);
}
