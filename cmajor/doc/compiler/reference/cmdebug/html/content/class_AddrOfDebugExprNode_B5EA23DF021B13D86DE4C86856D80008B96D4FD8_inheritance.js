...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::AddrOfDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AddrOfDebugExprNode_B5EA23DF021B13D86DE4C86856D80008B96D4FD8.html" }];
    drawDiagram(classes);
}
