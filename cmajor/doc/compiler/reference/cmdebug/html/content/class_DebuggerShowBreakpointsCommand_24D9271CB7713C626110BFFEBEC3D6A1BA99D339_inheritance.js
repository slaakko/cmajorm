...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerShowBreakpointsCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerShowBreakpointsCommand_24D9271CB7713C626110BFFEBEC3D6A1BA99D339.html" }];
    drawDiagram(classes);
}
