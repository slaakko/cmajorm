...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::ForwardList", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ForwardList_CCCB7FFF392FF82349A6709D3B9DF826800F3FCF.html" }];
    drawDiagram(classes);
}
