...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarInfoNumChildrenCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarInfoNumChildrenCommand_ABF541E7BDB37ED9F1E9B5932F0C507E3A6F0AD7.html" }];
    drawDiagram(classes);
}
