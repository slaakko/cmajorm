...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DIEnumType", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DIEnumType_8CC7FE9F33E53DCCCAD992CC5F2CB095301034F6.html" }];
    drawDiagram(classes);
}
