...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::TreeIterator", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TreeIterator_8A3B82950E74078816198487BD38CCC8D6680C8B.html" }];
    drawDiagram(classes);
}
