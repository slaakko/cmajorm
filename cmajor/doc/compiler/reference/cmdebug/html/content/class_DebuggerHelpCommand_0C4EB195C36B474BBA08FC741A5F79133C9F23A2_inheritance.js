...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerHelpCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerHelpCommand_0C4EB195C36B474BBA08FC741A5F79133C9F23A2.html" }];
    drawDiagram(classes);
}
