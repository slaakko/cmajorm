...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerListCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerListCommand_FA8131C81DAB734262E70434441A8260D9A94CB5.html" }];
    drawDiagram(classes);
}
