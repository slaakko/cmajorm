...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerStepCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerStepCommand_52C54E49F2434B352C499705AF84838AD4199003.html" }];
    drawDiagram(classes);
}
