...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::ListIterator", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ListIterator_6089FFBC1D0008B92138DF9CDBEA8D46F3EE9F60.html" }];
    drawDiagram(classes);
}
