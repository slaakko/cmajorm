...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarInfoExpressionCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarInfoExpressionCommand_174D7ADFE527980C996F1B34B0CF1AC93537A90C.html" }];
    drawDiagram(classes);
}
