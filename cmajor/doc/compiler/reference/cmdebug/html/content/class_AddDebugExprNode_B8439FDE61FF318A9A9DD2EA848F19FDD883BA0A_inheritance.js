...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::AddDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AddDebugExprNode_B8439FDE61FF318A9A9DD2EA848F19FDD883BA0A.html" }];
    drawDiagram(classes);
}
