...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::debug::BoundDebugNodeVisitor", id: "class_0", level: 0, subject: true, hasDerivedClasses: true, link: "./class_BoundDebugNodeVisitor_A92520720C205303C3EA473D600C1C64994F71D8.html" },
        { name: "cmajor::debug::ContainerSubscriptTranslator", id: "class_1", level: 1, subject: false, hasDerivedClasses: false, link: "./class_ContainerSubscriptTranslator_1E9461F4438C2D3298EAF37DB2A6F46C896C01B5.html" },
        { name: "cmajor::debug::DebugExpressionEvaluator", id: "class_2", level: 1, subject: false, hasDerivedClasses: false, link: "./class_DebugExpressionEvaluator_072E169E6C79BB7B20ECE9D51D9E7E35966FA77D.html" }];
    drawDiagram(classes);
}
