...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundRangeNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundRangeNode_83637FFD9786F9212E47006684643C449C831A8C.html" }];
    drawDiagram(classes);
}
