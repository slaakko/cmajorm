...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::debug::Iterator", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_Iterator_584C789A51F0D3F77B4A4DAE6508263C9E9A022B.html" },
        { name: "cmajor::debug::ForwardListIterator", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ForwardListIterator_BB31C6C359E760D3ECEAE63CBA67EFE007AB5271.html" }];
    drawDiagram(classes);
}
