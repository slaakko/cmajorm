...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExecStoppedRecord", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_GdbExecStoppedRecord_C4809802D5872EA15EE3EE733F4951076F9C24F8.html" }];
    drawDiagram(classes);
}
