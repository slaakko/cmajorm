...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerContinueCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerContinueCommand_A3700D134C05D05A1FEE4137270AF905F5764D0B.html" }];
    drawDiagram(classes);
}
