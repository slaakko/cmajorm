...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::HashtableIterator", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_HashtableIterator_A88B23BEF8C22F3671A06018512003A51763E5AE.html" }];
    drawDiagram(classes);
}
