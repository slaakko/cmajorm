...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DIClassDelegateType", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DIClassDelegateType_625862B25AEE952BAB584DB24384F3AD9A20E907.html" }];
    drawDiagram(classes);
}
