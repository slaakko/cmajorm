...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::CastDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CastDebugExprNode_FA953B0E6886EC3FD89E8D71273C2E4D09BA326B.html" }];
    drawDiagram(classes);
}
