...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::debug::DebuggerCommand", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_DebuggerCommand_9F3B9EAAA56166E034342A650AB5E8B3523ED275.html" },
        { name: "cmajor::debug::DebuggerSetBreakOnThrowCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerSetBreakOnThrowCommand_0C3C9CC09EDB1DA4185D65A434EE69C5D25E7949.html" }];
    drawDiagram(classes);
}
