...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarAssignCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarAssignCommand_241C8294A8FE17947340FE848272D1B138FC9002.html" }];
    drawDiagram(classes);
}
