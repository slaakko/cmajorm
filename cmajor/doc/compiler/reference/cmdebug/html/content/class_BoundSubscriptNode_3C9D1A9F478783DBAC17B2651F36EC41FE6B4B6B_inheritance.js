...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundSubscriptNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundSubscriptNode_3C9D1A9F478783DBAC17B2651F36EC41FE6B4B6B.html" }];
    drawDiagram(classes);
}
