...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExecUntilCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbExecUntilCommand_6BA1EC4E1300A77E0349B73C3C6D32E545BFCCE4.html" }];
    drawDiagram(classes);
}
