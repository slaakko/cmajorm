...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::ClassScope", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ClassScope_042B0F2256DEA4CB18BADCD4D6BFF56391D1E977.html" }];
    drawDiagram(classes);
}
