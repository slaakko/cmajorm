...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerDeleteCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerDeleteCommand_F1A3A26F65926719E92A0A79104E561877663568.html" }];
    drawDiagram(classes);
}
