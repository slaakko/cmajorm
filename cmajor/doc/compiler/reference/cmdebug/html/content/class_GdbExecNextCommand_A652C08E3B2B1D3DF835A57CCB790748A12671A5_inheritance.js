...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExecNextCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbExecNextCommand_A652C08E3B2B1D3DF835A57CCB790748A12671A5.html" }];
    drawDiagram(classes);
}
