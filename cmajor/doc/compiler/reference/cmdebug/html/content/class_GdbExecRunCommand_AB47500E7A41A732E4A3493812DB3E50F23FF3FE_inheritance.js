...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExecRunCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbExecRunCommand_AB47500E7A41A732E4A3493812DB3E50F23FF3FE.html" }];
    drawDiagram(classes);
}
