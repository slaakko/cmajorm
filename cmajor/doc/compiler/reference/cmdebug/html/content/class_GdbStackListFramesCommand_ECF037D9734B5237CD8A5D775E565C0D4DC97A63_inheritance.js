...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbStackListFramesCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbStackListFramesCommand_ECF037D9734B5237CD8A5D775E565C0D4DC97A63.html" }];
    drawDiagram(classes);
}
