...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerRepeatLatestCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerRepeatLatestCommand_C6A65B911CEFBA3450DD96909D3FC88F78A9C02A.html" }];
    drawDiagram(classes);
}
