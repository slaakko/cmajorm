...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundParenExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundParenExprNode_CDE6325E282A4CF8AA58A9DA924F3AA0EFC9D3D0.html" }];
    drawDiagram(classes);
}
