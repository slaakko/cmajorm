...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbPrompt", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbPrompt_C19627E5033EF3F412C0BBEF66B2B2624E104782.html" }];
    drawDiagram(classes);
}
