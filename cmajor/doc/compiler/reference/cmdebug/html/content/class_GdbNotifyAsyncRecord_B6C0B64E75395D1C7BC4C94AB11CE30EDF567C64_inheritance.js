...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbNotifyAsyncRecord", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GdbNotifyAsyncRecord_B6C0B64E75395D1C7BC4C94AB11CE30EDF567C64.html" }];
    drawDiagram(classes);
}
