...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DIReferenceType", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DIReferenceType_9A8F1326A15F5D3FFEDBA710D2954B59799AD544.html" }];
    drawDiagram(classes);
}
