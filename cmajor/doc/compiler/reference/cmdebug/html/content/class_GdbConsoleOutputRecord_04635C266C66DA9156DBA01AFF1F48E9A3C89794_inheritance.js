...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbStreamRecord", id: "class_1", level: 1, subject: false, hasDerivedClasses: true, link: "./class_GdbStreamRecord_9A64570F1543F1B9135DE1C315EF9E644733833E.html" },
        { name: "cmajor::debug::GdbConsoleOutputRecord", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GdbConsoleOutputRecord_04635C266C66DA9156DBA01AFF1F48E9A3C89794.html" }];
    drawDiagram(classes);
}
