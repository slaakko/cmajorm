...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbExitRecord", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GdbExitRecord_FA2F5B4C4545421B9B5A7F49B94C75C21B993251.html" }];
    drawDiagram(classes);
}
