...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::BoundSubNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BoundSubNode_E29899044141FC840DF7F1A75F0382738641D88F.html" }];
    drawDiagram(classes);
}
