...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::debug::CmdbSessionClient", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_CmdbSessionClient_610E146E52C991C7E4783DE87E6D1E979B656D36.html" },
        { name: "cmajor::debug::GdbDriver", id: "class_1", level: 0, subject: false, hasDerivedClasses: true, link: "./class_GdbDriver_570DF3C2D480E77A5461D24A867FB40ADFB7F8DE.html" },
        { name: "cmajor::debug::Debugger", id: "class_2", level: 1, subject: true, hasDerivedClasses: false, link: "./class_Debugger_7FE587CCCE2A5D5301F67F076DA4D2D8B1D2572B.html" }];
    drawDiagram(classes);
}
