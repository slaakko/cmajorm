...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbDeleteAllBreakpointsCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbDeleteAllBreakpointsCommand_0937FB91DA919F00277ED58C3879C5038156D8A8.html" }];
    drawDiagram(classes);
}
