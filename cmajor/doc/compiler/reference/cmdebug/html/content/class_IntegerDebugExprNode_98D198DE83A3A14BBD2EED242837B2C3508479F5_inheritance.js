...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::IntegerDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_IntegerDebugExprNode_98D198DE83A3A14BBD2EED242837B2C3508479F5.html" }];
    drawDiagram(classes);
}
