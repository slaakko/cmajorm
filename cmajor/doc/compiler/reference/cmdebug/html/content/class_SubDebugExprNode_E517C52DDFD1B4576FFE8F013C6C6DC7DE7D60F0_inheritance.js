...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::SubDebugExprNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SubDebugExprNode_E517C52DDFD1B4576FFE8F013C6C6DC7DE7D60F0.html" }];
    drawDiagram(classes);
}
