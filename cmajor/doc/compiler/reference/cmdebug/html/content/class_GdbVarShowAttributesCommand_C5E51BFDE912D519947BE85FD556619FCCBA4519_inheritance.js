...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::GdbVarShowAttributesCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GdbVarShowAttributesCommand_C5E51BFDE912D519947BE85FD556619FCCBA4519.html" }];
    drawDiagram(classes);
}
