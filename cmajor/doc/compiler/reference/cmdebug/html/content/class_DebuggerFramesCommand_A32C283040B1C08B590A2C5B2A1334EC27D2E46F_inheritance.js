...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::debug::DebuggerFramesCommand", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DebuggerFramesCommand_A32C283040B1C08B590A2C5B2A1334EC27D2E46F.html" }];
    drawDiagram(classes);
}
