...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::util::JsonNumber", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_JsonNumber_D145900EA9746387DFC1118AFF96C196D500CC2B.html" }];
    drawDiagram(classes);
}
