...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::mid::CmsxBackEnd", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CmsxBackEnd_A5CDA4F22ADDDDDB0E49041E6B17E1BFF3DBE585.html" }];
    drawDiagram(classes);
}
