...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::mid::LLvmBackEnd", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LLvmBackEnd_2F10B9CF37D68BBA98D1C977BFB20A73CA12B1B4.html" }];
    drawDiagram(classes);
}
