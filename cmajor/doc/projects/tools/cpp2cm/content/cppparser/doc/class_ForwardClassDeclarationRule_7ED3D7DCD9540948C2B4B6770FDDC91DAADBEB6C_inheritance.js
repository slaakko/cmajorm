...
function drawInheritanceDiagram() {
    var diagramNodes = [
        ...
        { name: "cppparser.ClassGrammar.ForwardClassDeclarationRule", id: "diagram_node_3", level: 3, subject: true, hasDerivedNodes: false, link: "../../cppparser/doc/class_ForwardClassDeclarationRule_7ED3D7DCD9540948C2B4B6770FDDC91DAADBEB6C.html" }];
