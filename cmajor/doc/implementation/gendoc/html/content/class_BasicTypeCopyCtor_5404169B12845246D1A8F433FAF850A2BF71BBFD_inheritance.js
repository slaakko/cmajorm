...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeCopyCtor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BasicTypeCopyCtor_5404169B12845246D1A8F433FAF850A2BF71BBFD.html" }];
    drawDiagram(classes);
}
