...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsShortTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsShortTypePredicate_C20E90FDD6B0F1665ABCE368985D7A2633812F0A.html" }];
    drawDiagram(classes);
}
