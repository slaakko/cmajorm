...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::binder::Operation", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "class_Operation_8F65927D68CA006D4A1FCF730CC955646E5C0F2E.html" },
        { name: "cmajor::binder::LvalueReferenceCopyConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_LvalueReferenceCopyConstructorOperation_67EE3704A3480FFCC9FC764BC3BF880B9A52D050.html" }];
    drawDiagram(classes);
}
