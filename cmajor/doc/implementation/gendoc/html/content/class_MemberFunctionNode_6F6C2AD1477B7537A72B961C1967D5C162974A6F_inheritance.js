...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::MemberFunctionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_MemberFunctionNode_6F6C2AD1477B7537A72B961C1967D5C162974A6F.html" }];
    drawDiagram(classes);
}
