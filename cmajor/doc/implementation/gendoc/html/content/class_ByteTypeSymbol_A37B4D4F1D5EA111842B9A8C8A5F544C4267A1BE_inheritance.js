...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ByteTypeSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_ByteTypeSymbol_A37B4D4F1D5EA111842B9A8C8A5F544C4267A1BE.html" }];
    drawDiagram(classes);
}
