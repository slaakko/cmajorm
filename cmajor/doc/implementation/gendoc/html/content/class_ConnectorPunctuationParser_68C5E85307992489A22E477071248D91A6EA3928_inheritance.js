...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::ConnectorPunctuationParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ConnectorPunctuationParser_68C5E85307992489A22E477071248D91A6EA3928.html" }];
    drawDiagram(classes);
}
