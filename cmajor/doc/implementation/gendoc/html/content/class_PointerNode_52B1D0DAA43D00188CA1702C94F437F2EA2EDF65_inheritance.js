...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::PointerNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_PointerNode_52B1D0DAA43D00188CA1702C94F437F2EA2EDF65.html" }];
    drawDiagram(classes);
}
