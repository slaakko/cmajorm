...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::TemplateIdNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_TemplateIdNode_F438015A719C74294AC166E43FDE34F0D577057C.html" }];
    drawDiagram(classes);
}
