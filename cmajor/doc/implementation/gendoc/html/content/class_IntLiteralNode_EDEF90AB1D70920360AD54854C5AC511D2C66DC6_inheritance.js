...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::IntLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IntLiteralNode_EDEF90AB1D70920360AD54854C5AC511D2C66DC6.html" }];
    drawDiagram(classes);
}
