...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::WhileStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_WhileStatementNode_55EE576177721DDB89FC3888605492A4C2BA301F.html" }];
    drawDiagram(classes);
}
