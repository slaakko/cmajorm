...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::DoubleNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_DoubleNode_F75FD29766F88AFC54AB08F31D57BD0CA20C305B.html" }];
    drawDiagram(classes);
}
