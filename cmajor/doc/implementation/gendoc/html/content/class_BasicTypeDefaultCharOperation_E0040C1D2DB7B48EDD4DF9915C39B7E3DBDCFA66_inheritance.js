...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeDefaultCharOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeDefaultCharOperation_E0040C1D2DB7B48EDD4DF9915C39B7E3DBDCFA66.html" }];
    drawDiagram(classes);
}
