...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::UsingObject", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_UsingObject_6D4A48BD51139CA67B48715BEDFB1CFF647DAF15.html" }];
    drawDiagram(classes);
}
