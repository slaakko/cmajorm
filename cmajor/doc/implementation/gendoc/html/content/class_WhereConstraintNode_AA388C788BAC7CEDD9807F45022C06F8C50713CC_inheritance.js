...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::WhereConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_WhereConstraintNode_AA388C788BAC7CEDD9807F45022C06F8C50713CC.html" }];
    drawDiagram(classes);
}
