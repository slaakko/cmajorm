...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::FloatTypeSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_FloatTypeSymbol_719BEABCB9AF3A7BFE2A976E2A0F9428D8604434.html" }];
    drawDiagram(classes);
}
