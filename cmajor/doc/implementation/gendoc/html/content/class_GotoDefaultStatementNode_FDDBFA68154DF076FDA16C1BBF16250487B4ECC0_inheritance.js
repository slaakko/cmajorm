...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::GotoDefaultStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_GotoDefaultStatementNode_FDDBFA68154DF076FDA16C1BBF16250487B4ECC0.html" }];
    drawDiagram(classes);
}
