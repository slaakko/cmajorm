...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::RValueRefNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_RValueRefNode_6667F440467E1256EE90F8791A06AC133458FFC1.html" }];
    drawDiagram(classes);
}
