...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::InterfaceNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_InterfaceNode_8CEFA1F425668F852574D2197AA1FD374A2B0D3C.html" }];
    drawDiagram(classes);
}
