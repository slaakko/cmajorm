...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::InterfaceMoveAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_InterfaceMoveAssignmentOperation_EDCA18A7A8192454DC5377C144A32A00FD87C1F3.html" }];
    drawDiagram(classes);
}
