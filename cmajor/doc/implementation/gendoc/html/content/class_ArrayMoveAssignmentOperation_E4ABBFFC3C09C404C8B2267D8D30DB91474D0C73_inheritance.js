...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ArrayMoveAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ArrayMoveAssignmentOperation_E4ABBFFC3C09C404C8B2267D8D30DB91474D0C73.html" }];
    drawDiagram(classes);
}
