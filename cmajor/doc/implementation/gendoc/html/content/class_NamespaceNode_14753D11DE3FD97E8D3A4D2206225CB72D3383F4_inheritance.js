...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::NamespaceNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_NamespaceNode_14753D11DE3FD97E8D3A4D2206225CB72D3383F4.html" }];
    drawDiagram(classes);
}
