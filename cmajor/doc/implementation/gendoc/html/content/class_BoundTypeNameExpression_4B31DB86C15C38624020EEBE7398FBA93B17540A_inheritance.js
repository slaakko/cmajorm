...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundTypeNameExpression", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundTypeNameExpression_4B31DB86C15C38624020EEBE7398FBA93B17540A.html" }];
    drawDiagram(classes);
}
