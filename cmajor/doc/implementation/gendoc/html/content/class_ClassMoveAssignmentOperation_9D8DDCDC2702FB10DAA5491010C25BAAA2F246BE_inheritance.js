...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ClassMoveAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ClassMoveAssignmentOperation_9D8DDCDC2702FB10DAA5491010C25BAAA2F246BE.html" }];
    drawDiagram(classes);
}
