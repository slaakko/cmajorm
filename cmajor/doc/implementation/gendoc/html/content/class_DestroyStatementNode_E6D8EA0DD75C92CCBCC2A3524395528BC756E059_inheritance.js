...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::DestroyStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_DestroyStatementNode_E6D8EA0DD75C92CCBCC2A3524395528BC756E059.html" }];
    drawDiagram(classes);
}
