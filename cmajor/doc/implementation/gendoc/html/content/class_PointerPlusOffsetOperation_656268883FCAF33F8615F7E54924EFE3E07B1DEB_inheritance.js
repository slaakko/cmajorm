...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerPlusOffsetOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_PointerPlusOffsetOperation_656268883FCAF33F8615F7E54924EFE3E07B1DEB.html" }];
    drawDiagram(classes);
}
