...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeDefaultDoubleOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeDefaultDoubleOperation_F80E95A8C5DB272746CAFE893DAF2A5D699FBDF8.html" }];
    drawDiagram(classes);
}
