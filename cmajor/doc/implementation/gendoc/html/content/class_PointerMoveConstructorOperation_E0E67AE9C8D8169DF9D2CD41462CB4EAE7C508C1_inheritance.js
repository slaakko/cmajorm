...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerMoveConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_PointerMoveConstructorOperation_E0E67AE9C8D8169DF9D2CD41462CB4EAE7C508C1.html" }];
    drawDiagram(classes);
}
