...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ConstantSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ConstantSymbol_C24F6B6BF615227AB82DFBE1F620EA7AC3355A15.html" }];
    drawDiagram(classes);
}
