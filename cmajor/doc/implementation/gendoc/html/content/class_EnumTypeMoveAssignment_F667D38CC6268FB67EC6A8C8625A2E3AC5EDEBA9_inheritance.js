...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeMoveAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_EnumTypeMoveAssignment_F667D38CC6268FB67EC6A8C8625A2E3AC5EDEBA9.html" }];
    drawDiagram(classes);
}
