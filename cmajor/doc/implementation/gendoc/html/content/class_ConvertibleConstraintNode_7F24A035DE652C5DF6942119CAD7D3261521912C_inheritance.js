...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConvertibleConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ConvertibleConstraintNode_7F24A035DE652C5DF6942119CAD7D3261521912C.html" }];
    drawDiagram(classes);
}
