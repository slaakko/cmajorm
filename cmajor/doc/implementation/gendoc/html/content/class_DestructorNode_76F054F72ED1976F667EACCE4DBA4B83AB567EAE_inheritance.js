...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::DestructorNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_DestructorNode_76F054F72ED1976F667EACCE4DBA4B83AB567EAE.html" }];
    drawDiagram(classes);
}
