...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeFloatingExtensionOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "class_BasicTypeFloatingExtensionOperation_AFF97E03D86416E4D3B17848A44C7EFDA134A70B.html" }];
    drawDiagram(classes);
}
