...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::EmptyStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_EmptyStatementNode_FEC7B4F234FD613B891D150B3E2FCE69CAAA56AB.html" }];
    drawDiagram(classes);
}
