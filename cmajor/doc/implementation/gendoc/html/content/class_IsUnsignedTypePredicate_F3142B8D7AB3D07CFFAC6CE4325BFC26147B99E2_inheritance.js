...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsUnsignedTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsUnsignedTypePredicate_F3142B8D7AB3D07CFFAC6CE4325BFC26147B99E2.html" }];
    drawDiagram(classes);
}
