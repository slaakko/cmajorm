...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::ParagraphSeparatorParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ParagraphSeparatorParser_E8EE8D34FE541B8CD1238B67C7381C7B9E911911.html" }];
    drawDiagram(classes);
}
