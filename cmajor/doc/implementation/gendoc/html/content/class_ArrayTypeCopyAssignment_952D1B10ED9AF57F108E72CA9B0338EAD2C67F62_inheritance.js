...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayTypeCopyAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ArrayTypeCopyAssignment_952D1B10ED9AF57F108E72CA9B0338EAD2C67F62.html" }];
    drawDiagram(classes);
}
