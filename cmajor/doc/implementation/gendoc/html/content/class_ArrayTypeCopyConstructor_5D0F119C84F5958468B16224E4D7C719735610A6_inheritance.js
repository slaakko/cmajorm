...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayTypeCopyConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ArrayTypeCopyConstructor_5D0F119C84F5958468B16224E4D7C719735610A6.html" }];
    drawDiagram(classes);
}
