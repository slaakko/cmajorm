...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::ClosePunctuationParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ClosePunctuationParser_89D89F8972BB7BF6FE769105870C29E72B067547.html" }];
    drawDiagram(classes);
}
