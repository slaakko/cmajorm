...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::SeparatorParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_SeparatorParser_BBD5C188DDA429B54C1533BBE0055B3EB6B64F24.html" }];
    drawDiagram(classes);
}
