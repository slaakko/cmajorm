...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::SpaceSeparatorParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_SpaceSeparatorParser_3616F1C67A32BA805BCA3899974540AB456C0B69.html" }];
    drawDiagram(classes);
}
