...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundRethrowStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundRethrowStatement_A720CEC1C74090443C19A23C0876F5A5D62007AA.html" }];
    drawDiagram(classes);
}
