...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundFunctionCall", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundFunctionCall_3B6FF42595EC5C47E14802245CBCB5F47F5F3EAC.html" }];
    drawDiagram(classes);
}
