...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::RangeForStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_RangeForStatementNode_EFD048A5EBA76CEC9675351105634FBDC66A8EE4.html" }];
    drawDiagram(classes);
}
