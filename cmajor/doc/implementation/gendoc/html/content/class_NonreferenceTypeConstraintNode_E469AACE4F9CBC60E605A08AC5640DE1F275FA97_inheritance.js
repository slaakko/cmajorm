...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::NonreferenceTypeConstraintNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_NonreferenceTypeConstraintNode_E469AACE4F9CBC60E605A08AC5640DE1F275FA97.html" }];
    drawDiagram(classes);
}
