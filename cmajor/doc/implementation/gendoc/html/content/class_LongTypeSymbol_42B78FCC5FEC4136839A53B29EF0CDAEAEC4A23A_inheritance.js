...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::LongTypeSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_LongTypeSymbol_42B78FCC5FEC4136839A53B29EF0CDAEAEC4A23A.html" }];
    drawDiagram(classes);
}
