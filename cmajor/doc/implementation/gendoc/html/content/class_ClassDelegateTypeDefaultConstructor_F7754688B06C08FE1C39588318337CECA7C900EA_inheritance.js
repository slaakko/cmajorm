...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ClassDelegateTypeDefaultConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ClassDelegateTypeDefaultConstructor_F7754688B06C08FE1C39588318337CECA7C900EA.html" }];
    drawDiagram(classes);
}
