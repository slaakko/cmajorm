...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeTruncationOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "class_BasicTypeTruncationOperation_B4221CDD30B708DAA716C4A710F62C767B1B0030.html" }];
    drawDiagram(classes);
}
