...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundClassOrClassDelegateConversionResult", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundClassOrClassDelegateConversionResult_D567FAC30733A2FFC5F2046B64EE2668ECCB14D4.html" }];
    drawDiagram(classes);
}
