...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundConstructExpression", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundConstructExpression_9519ADD2DD5B4CD90CB0E2D0B6F5839B8EC86FEE.html" }];
    drawDiagram(classes);
}
