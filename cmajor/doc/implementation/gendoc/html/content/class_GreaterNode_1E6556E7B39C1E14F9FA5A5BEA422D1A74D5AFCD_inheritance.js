...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::GreaterNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_GreaterNode_1E6556E7B39C1E14F9FA5A5BEA422D1A74D5AFCD.html" }];
    drawDiagram(classes);
}
