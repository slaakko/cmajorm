...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::NumberParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_NumberParser_8FB3147501E18E6F061250A0AD28DB965A56AA6C.html" }];
    drawDiagram(classes);
}
