...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsBasicTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsBasicTypePredicate_405C86501EB896773CDE81CCC707600CFC8B129E.html" }];
    drawDiagram(classes);
}
