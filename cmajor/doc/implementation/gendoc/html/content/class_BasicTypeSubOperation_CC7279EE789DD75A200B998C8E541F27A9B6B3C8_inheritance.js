...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeSubOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeSubOperation_CC7279EE789DD75A200B998C8E541F27A9B6B3C8.html" }];
    drawDiagram(classes);
}
