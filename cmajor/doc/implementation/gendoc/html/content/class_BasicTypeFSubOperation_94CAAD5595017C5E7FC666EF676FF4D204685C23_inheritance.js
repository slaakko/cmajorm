...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeFSubOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeFSubOperation_94CAAD5595017C5E7FC666EF676FF4D204685C23.html" }];
    drawDiagram(classes);
}
