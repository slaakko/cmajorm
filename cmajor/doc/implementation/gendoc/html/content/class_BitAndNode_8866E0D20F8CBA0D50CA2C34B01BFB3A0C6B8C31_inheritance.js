...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::BitAndNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_BitAndNode_8866E0D20F8CBA0D50CA2C34B01BFB3A0C6B8C31.html" }];
    drawDiagram(classes);
}
