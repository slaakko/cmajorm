...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::PostfixDecrementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_PostfixDecrementNode_1A238FD0198DB87AEE9BF04FFA52C97E76AD4FAD.html" }];
    drawDiagram(classes);
}
