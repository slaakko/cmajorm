...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ConceptSymbol", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ConceptSymbol_480671C9D512EFD41CDF07DFD5D4A47F11E07A99.html" }];
    drawDiagram(classes);
}
