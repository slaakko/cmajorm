...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConditionalCompilationDisjunctionNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ConditionalCompilationDisjunctionNode_07175702945449C7EE06D69CF9215BF01A0AE3B3.html" }];
    drawDiagram(classes);
}
