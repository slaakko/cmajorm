...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeIntegerEqualityOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeIntegerEqualityOperation_35728D30A6EAEF9AC9BF88C035A35B7DD32CAE9A.html" }];
    drawDiagram(classes);
}
