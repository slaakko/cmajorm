...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::CharLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_CharLiteralNode_853FD806B72D3BA619C7A151EBD108B75C80A23A.html" }];
    drawDiagram(classes);
}
