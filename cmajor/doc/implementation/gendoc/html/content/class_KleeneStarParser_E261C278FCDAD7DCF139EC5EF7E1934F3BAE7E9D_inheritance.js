...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::KleeneStarParser", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_KleeneStarParser_E261C278FCDAD7DCF139EC5EF7E1934F3BAE7E9D.html" }];
    drawDiagram(classes);
}
