...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::EquivalenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_EquivalenceNode_2A966D87C0CFD5EEC6E8376AF2572607FED4A84A.html" }];
    drawDiagram(classes);
}
