...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::CurrencySymbolParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_CurrencySymbolParser_2008E4F4392C2A0DEF0DEA115616C8CF26307E96.html" }];
    drawDiagram(classes);
}
