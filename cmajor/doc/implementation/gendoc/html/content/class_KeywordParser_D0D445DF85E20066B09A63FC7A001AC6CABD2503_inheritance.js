...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::KeywordParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_KeywordParser_D0D445DF85E20066B09A63FC7A001AC6CABD2503.html" }];
    drawDiagram(classes);
}
