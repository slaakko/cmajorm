...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ExpressionStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ExpressionStatementNode_22F62CCFF31C0C80014243627F4B1EA0D7DFA78B.html" }];
    drawDiagram(classes);
}
