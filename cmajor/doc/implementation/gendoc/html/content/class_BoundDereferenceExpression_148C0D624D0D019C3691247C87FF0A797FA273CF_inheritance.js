...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundDereferenceExpression", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundDereferenceExpression_148C0D624D0D019C3691247C87FF0A797FA273CF.html" }];
    drawDiagram(classes);
}
