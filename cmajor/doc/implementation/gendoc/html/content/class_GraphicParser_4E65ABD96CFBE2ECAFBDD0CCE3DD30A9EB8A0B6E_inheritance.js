...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::GraphicParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_GraphicParser_4E65ABD96CFBE2ECAFBDD0CCE3DD30A9EB8A0B6E.html" }];
    drawDiagram(classes);
}
