...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::ParsingDomain", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ParsingDomain_61DCEDE37EC9E175977FD613BC12969D327A4FC4.html" }];
    drawDiagram(classes);
}
