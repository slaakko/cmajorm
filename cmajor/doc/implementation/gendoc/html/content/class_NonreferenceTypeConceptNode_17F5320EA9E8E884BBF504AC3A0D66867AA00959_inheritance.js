...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::NonreferenceTypeConceptNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_NonreferenceTypeConceptNode_17F5320EA9E8E884BBF504AC3A0D66867AA00959.html" }];
    drawDiagram(classes);
}
