...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::emitter::LinuxEmitter", id: "class_3", level: 2, subject: true, hasDerivedClasses: false, link: "class_LinuxEmitter_0D6C8F1D40184D7E33A54EFC6DCC19251B9A9F32.html" }];
    drawDiagram(classes);
}
