...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cmajor::parsing::PostCall", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "class_PostCall_831A1A9C2B737304A4150CBBF2838469697EBD8A.html" },
        { name: "cmajor::parsing::MemberPostCall&lt;Type&gt;", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_MemberPostCall_04C3D1ADB8BAA1CF4449104C41BA4350C6A999B2.html" }];
    drawDiagram(classes);
}
