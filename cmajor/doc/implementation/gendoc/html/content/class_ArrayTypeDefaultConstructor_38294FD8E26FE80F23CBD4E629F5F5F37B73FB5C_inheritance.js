...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayTypeDefaultConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ArrayTypeDefaultConstructor_38294FD8E26FE80F23CBD4E629F5F5F37B73FB5C.html" }];
    drawDiagram(classes);
}
