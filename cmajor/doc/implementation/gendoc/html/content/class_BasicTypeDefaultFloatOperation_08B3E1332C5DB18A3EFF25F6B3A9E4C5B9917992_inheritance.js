...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeDefaultFloatOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeDefaultFloatOperation_08B3E1332C5DB18A3EFF25F6B3A9E4C5B9917992.html" }];
    drawDiagram(classes);
}
