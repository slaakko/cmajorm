...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ContinueStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ContinueStatementNode_1D07468CCF3BA26F71F1C6FF4AD987D8A5B5EB3E.html" }];
    drawDiagram(classes);
}
