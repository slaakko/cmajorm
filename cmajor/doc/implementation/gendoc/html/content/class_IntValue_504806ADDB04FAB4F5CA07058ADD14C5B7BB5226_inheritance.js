...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IntValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_IntValue_504806ADDB04FAB4F5CA07058ADD14C5B7BB5226.html" }];
    drawDiagram(classes);
}
