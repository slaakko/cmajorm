...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundWhileStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundWhileStatement_34710CA10F2EDB4A9B691B578C1B3F261E4C79FD.html" }];
    drawDiagram(classes);
}
