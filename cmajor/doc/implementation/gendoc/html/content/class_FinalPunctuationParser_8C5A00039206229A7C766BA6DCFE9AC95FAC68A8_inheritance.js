...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::FinalPunctuationParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_FinalPunctuationParser_8C5A00039206229A7C766BA6DCFE9AC95FAC68A8.html" }];
    drawDiagram(classes);
}
