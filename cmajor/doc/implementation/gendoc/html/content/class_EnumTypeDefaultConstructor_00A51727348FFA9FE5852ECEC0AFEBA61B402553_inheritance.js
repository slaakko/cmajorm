...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeDefaultConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_EnumTypeDefaultConstructor_00A51727348FFA9FE5852ECEC0AFEBA61B402553.html" }];
    drawDiagram(classes);
}
