...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::UuidLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_UuidLiteralNode_DE3DFDBE49C41D2302DD5EF6B4675F9E98C4579B.html" }];
    drawDiagram(classes);
}
