...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ForStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ForStatementNode_D09288619FB91C32246D0AC86C0333311B7DBD31.html" }];
    drawDiagram(classes);
}
