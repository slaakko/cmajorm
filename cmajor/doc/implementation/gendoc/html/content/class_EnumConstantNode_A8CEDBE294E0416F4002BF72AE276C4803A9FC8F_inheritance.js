...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::EnumConstantNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_EnumConstantNode_A8CEDBE294E0416F4002BF72AE276C4803A9FC8F.html" }];
    drawDiagram(classes);
}
