...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeImplicitSignedIntToFloatingOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "class_BasicTypeImplicitSignedIntToFloatingOperation_F55C51B84C4CE2C458C1E4942BFE7F5643490C1A.html" }];
    drawDiagram(classes);
}
