...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ClassCopyConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ClassCopyConstructorOperation_420966589808DE3929D7FAB4935D9C576328DE84.html" }];
    drawDiagram(classes);
}
