...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::IdStartParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IdStartParser_C1757FCB4DCFB0C20ECD233ABFFA39DBBA7D2CFE.html" }];
    drawDiagram(classes);
}
