...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::DefaultStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_DefaultStatementNode_1D5415B64C2A9A56EC7013C40FFA0504C42C66DF.html" }];
    drawDiagram(classes);
}
