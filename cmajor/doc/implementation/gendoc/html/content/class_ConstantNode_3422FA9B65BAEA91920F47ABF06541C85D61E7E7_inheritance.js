...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConstantNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ConstantNode_3422FA9B65BAEA91920F47ABF06541C85D61E7E7.html" }];
    drawDiagram(classes);
}
