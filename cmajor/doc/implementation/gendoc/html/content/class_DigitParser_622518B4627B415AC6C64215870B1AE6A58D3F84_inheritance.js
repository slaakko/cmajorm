...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::DigitParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_DigitParser_622518B4627B415AC6C64215870B1AE6A58D3F84.html" }];
    drawDiagram(classes);
}
