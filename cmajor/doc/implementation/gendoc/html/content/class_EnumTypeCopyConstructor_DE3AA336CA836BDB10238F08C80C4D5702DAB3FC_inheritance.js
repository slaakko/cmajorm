...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::EnumTypeCopyConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_EnumTypeCopyConstructor_DE3AA336CA836BDB10238F08C80C4D5702DAB3FC.html" }];
    drawDiagram(classes);
}
