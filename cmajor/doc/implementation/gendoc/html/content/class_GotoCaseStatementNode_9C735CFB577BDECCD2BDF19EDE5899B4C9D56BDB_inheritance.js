...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::GotoCaseStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_GotoCaseStatementNode_9C735CFB577BDECCD2BDF19EDE5899B4C9D56BDB.html" }];
    drawDiagram(classes);
}
