...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::DisjunctionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_DisjunctionNode_29948A0AC945F87498F3BC1B149A8B9A448C28FF.html" }];
    drawDiagram(classes);
}
