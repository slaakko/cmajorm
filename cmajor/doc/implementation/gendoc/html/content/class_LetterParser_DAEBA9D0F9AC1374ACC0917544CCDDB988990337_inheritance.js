...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::LetterParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_LetterParser_DAEBA9D0F9AC1374ACC0917544CCDDB988990337.html" }];
    drawDiagram(classes);
}
