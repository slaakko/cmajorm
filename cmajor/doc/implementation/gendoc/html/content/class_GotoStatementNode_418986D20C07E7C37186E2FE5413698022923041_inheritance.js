...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::GotoStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_GotoStatementNode_418986D20C07E7C37186E2FE5413698022923041.html" }];
    drawDiagram(classes);
}
