...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::UnaryMinusNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_UnaryMinusNode_D3A241789993A8811CBCF9C9C98DB026BC3F6A85.html" }];
    drawDiagram(classes);
}
