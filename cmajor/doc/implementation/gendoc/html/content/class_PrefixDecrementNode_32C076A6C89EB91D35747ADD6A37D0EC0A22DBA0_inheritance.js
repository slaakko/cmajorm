...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::PrefixDecrementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_PrefixDecrementNode_32C076A6C89EB91D35747ADD6A37D0EC0A22DBA0.html" }];
    drawDiagram(classes);
}
