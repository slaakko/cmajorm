...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::LetterNumberParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_LetterNumberParser_AF635C50BFF1C75AD06476B161687930A9E0AFF3.html" }];
    drawDiagram(classes);
}
