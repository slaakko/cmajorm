...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundTypeExpression", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundTypeExpression_C2681C3ACE7F6FBEBF9AD6464D7478D7E60F3A3A.html" }];
    drawDiagram(classes);
}
