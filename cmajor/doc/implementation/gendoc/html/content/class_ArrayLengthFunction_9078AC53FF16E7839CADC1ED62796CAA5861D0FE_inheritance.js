...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayLengthFunction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ArrayLengthFunction_9078AC53FF16E7839CADC1ED62796CAA5861D0FE.html" }];
    drawDiagram(classes);
}
