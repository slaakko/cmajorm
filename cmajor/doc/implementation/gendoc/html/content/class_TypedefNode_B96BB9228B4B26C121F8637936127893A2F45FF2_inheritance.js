...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::TypedefNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_TypedefNode_B96BB9228B4B26C121F8637936127893A2F45FF2.html" }];
    drawDiagram(classes);
}
