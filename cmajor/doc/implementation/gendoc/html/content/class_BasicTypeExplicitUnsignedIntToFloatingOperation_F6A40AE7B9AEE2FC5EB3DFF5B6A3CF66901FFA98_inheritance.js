...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeExplicitUnsignedIntToFloatingOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "class_BasicTypeExplicitUnsignedIntToFloatingOperation_F6A40AE7B9AEE2FC5EB3DFF5B6A3CF66901FFA98.html" }];
    drawDiagram(classes);
}
