...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeFloatingEqualityOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeFloatingEqualityOperation_5F412265A2A454147DACFED4B8A5329C62992B4E.html" }];
    drawDiagram(classes);
}
