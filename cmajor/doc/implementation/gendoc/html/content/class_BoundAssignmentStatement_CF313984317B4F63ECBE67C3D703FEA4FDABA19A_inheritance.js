...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundAssignmentStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundAssignmentStatement_CF313984317B4F63ECBE67C3D703FEA4FDABA19A.html" }];
    drawDiagram(classes);
}
