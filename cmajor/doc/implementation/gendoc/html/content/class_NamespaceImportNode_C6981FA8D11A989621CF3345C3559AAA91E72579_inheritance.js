...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::NamespaceImportNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_NamespaceImportNode_C6981FA8D11A989621CF3345C3559AAA91E72579.html" }];
    drawDiagram(classes);
}
