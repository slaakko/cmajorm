...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::UShortValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_UShortValue_9D6DCA00DA10F2F909978AC7DC1982CED1A7A6DF.html" }];
    drawDiagram(classes);
}
