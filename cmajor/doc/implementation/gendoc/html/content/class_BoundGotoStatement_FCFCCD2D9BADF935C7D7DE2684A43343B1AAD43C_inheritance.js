...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundGotoStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundGotoStatement_FCFCCD2D9BADF935C7D7DE2684A43343B1AAD43C.html" }];
    drawDiagram(classes);
}
