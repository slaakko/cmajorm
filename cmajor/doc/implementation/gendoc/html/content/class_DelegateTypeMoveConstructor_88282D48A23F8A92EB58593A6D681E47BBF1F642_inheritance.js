...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateTypeMoveConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_DelegateTypeMoveConstructor_88282D48A23F8A92EB58593A6D681E47BBF1F642.html" }];
    drawDiagram(classes);
}
