...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_DelegateTypeSymbol_3FECFD791A79DBF75CEC1BB6ABFDF26828491EDF.html" }];
    drawDiagram(classes);
}
