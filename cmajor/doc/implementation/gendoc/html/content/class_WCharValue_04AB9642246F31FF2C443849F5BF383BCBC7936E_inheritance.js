...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::WCharValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_WCharValue_04AB9642246F31FF2C443849F5BF383BCBC7936E.html" }];
    drawDiagram(classes);
}
