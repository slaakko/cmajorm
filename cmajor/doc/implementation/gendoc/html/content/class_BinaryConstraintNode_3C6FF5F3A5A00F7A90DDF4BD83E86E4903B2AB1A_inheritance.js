...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::BinaryConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: true, link: "class_BinaryConstraintNode_3C6FF5F3A5A00F7A90DDF4BD83E86E4903B2AB1A.html" },
        { name: "cmajor::ast::ConjunctiveConstraintNode", id: "class_3", level: 3, subject: false, hasDerivedClasses: false, link: "class_ConjunctiveConstraintNode_394190182105179AB115233C12577CDF74B2D51D.html" },
        { name: "cmajor::ast::DisjunctiveConstraintNode", id: "class_4", level: 3, subject: false, hasDerivedClasses: false, link: "class_DisjunctiveConstraintNode_F4A03C519962BEF3E6F44D11BC640D7256CFD85D.html" }];
    drawDiagram(classes);
}
