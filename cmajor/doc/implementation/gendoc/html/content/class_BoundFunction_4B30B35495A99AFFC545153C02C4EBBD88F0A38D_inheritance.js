...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundFunction", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_BoundFunction_4B30B35495A99AFFC545153C02C4EBBD88F0A38D.html" }];
    drawDiagram(classes);
}
