...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsSignedTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsSignedTypePredicate_84CE2A555CA6FC018164A0A030CBEC618F1D8B2C.html" }];
    drawDiagram(classes);
}
