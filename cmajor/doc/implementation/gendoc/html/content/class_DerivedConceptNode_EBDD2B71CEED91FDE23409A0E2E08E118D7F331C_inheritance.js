...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::DerivedConceptNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_DerivedConceptNode_EBDD2B71CEED91FDE23409A0E2E08E118D7F331C.html" }];
    drawDiagram(classes);
}
