...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::DelegateNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_DelegateNode_F4F4A951C249D2E6BFC9367C1A60DA7EF765C838.html" }];
    drawDiagram(classes);
}
