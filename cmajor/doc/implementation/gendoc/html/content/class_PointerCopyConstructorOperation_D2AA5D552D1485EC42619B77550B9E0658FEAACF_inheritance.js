...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerCopyConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_PointerCopyConstructorOperation_D2AA5D552D1485EC42619B77550B9E0658FEAACF.html" }];
    drawDiagram(classes);
}
