...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::LongLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_LongLiteralNode_A3EEBBE9EAD6AB77DEB64EF9F16E5A5EE6E7FC9C.html" }];
    drawDiagram(classes);
}
