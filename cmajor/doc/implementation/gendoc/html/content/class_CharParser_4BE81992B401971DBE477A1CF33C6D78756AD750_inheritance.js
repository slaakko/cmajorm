...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::CharParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_CharParser_4BE81992B401971DBE477A1CF33C6D78756AD750.html" }];
    drawDiagram(classes);
}
