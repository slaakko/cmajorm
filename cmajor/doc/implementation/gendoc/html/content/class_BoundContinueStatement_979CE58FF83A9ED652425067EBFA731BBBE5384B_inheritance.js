...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundContinueStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundContinueStatement_979CE58FF83A9ED652425067EBFA731BBBE5384B.html" }];
    drawDiagram(classes);
}
