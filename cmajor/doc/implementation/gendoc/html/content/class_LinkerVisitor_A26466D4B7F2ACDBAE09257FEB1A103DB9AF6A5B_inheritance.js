...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::LinkerVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_LinkerVisitor_A26466D4B7F2ACDBAE09257FEB1A103DB9AF6A5B.html" }];
    drawDiagram(classes);
}
