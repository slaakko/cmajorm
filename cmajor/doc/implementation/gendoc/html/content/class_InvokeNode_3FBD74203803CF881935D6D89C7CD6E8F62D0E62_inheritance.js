...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::InvokeNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_InvokeNode_3FBD74203803CF881935D6D89C7CD6E8F62D0E62.html" }];
    drawDiagram(classes);
}
