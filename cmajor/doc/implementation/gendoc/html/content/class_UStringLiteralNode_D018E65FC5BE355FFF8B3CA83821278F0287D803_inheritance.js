...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::UStringLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_UStringLiteralNode_D018E65FC5BE355FFF8B3CA83821278F0287D803.html" }];
    drawDiagram(classes);
}
