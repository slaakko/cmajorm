...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::UShortNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_UShortNode_FC23A6B0F63A8B6743984B39906CAF83F2A612AF.html" }];
    drawDiagram(classes);
}
