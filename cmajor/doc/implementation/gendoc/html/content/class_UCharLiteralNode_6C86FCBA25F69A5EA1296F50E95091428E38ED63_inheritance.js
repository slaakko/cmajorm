...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::UCharLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_UCharLiteralNode_6C86FCBA25F69A5EA1296F50E95091428E38ED63.html" }];
    drawDiagram(classes);
}
