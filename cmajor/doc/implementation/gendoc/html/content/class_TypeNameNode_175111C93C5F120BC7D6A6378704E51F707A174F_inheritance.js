...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::TypeNameNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_TypeNameNode_175111C93C5F120BC7D6A6378704E51F707A174F.html" }];
    drawDiagram(classes);
}
