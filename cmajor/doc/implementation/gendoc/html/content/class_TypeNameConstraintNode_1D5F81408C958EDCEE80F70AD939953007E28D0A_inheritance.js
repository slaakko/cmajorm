...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::TypeNameConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_TypeNameConstraintNode_1D5F81408C958EDCEE80F70AD939953007E28D0A.html" }];
    drawDiagram(classes);
}
