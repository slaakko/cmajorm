...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::FloatLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_FloatLiteralNode_947EDC5869A9988296DAC286558871AA4A279B87.html" }];
    drawDiagram(classes);
}
