...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ArrayTypeSymbol_0A220BDED10648126A9C249A2B866EDE0E28CF71.html" }];
    drawDiagram(classes);
}
