...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::SByteLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_SByteLiteralNode_EFFA2127AAF162622EFC2733821C513239CE30DE.html" }];
    drawDiagram(classes);
}
