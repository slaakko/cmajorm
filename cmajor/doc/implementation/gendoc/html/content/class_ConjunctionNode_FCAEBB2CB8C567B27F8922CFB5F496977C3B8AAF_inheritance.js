...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConjunctionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ConjunctionNode_FCAEBB2CB8C567B27F8922CFB5F496977C3B8AAF.html" }];
    drawDiagram(classes);
}
