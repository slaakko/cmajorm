...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsConstTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsConstTypePredicate_C6215B9C32349BB63B11D27327E61C12ED32FE94.html" }];
    drawDiagram(classes);
}
