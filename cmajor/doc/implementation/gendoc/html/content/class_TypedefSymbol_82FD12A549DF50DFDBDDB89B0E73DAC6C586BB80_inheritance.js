...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::TypedefSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_TypedefSymbol_82FD12A549DF50DFDBDDB89B0E73DAC6C586BB80.html" }];
    drawDiagram(classes);
}
