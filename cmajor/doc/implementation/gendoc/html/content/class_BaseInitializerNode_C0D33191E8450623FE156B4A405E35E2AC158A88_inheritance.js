...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::BaseInitializerNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_BaseInitializerNode_C0D33191E8450623FE156B4A405E35E2AC158A88.html" }];
    drawDiagram(classes);
}
