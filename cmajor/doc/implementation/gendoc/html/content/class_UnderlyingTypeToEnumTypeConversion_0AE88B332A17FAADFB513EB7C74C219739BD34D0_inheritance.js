...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::UnderlyingTypeToEnumTypeConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_UnderlyingTypeToEnumTypeConversion_0AE88B332A17FAADFB513EB7C74C219739BD34D0.html" }];
    drawDiagram(classes);
}
