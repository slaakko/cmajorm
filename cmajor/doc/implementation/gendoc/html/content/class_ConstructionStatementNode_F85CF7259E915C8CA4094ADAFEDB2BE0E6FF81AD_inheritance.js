...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConstructionStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ConstructionStatementNode_F85CF7259E915C8CA4094ADAFEDB2BE0E6FF81AD.html" }];
    drawDiagram(classes);
}
