...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ClassToInterfaceConversion", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ClassToInterfaceConversion_85BD4B0B5D40814F624C33A15507EDCBD8602B1C.html" }];
    drawDiagram(classes);
}
