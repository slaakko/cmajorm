...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeUnaryPlusOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeUnaryPlusOperation_D85064559E3CA1300EE6834C207EF9EB3F44B791.html" }];
    drawDiagram(classes);
}
