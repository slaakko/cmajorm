...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayEndFunction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ArrayEndFunction_1B398C4882F41336C2807F45A8E2E9A631866FF1.html" }];
    drawDiagram(classes);
}
