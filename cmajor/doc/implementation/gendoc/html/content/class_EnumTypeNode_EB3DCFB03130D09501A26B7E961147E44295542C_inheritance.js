...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::EnumTypeNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_EnumTypeNode_EB3DCFB03130D09501A26B7E961147E44295542C.html" }];
    drawDiagram(classes);
}
