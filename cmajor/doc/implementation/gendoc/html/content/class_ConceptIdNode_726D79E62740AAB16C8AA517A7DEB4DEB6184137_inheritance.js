...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConceptIdNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ConceptIdNode_726D79E62740AAB16C8AA517A7DEB4DEB6184137.html" }];
    drawDiagram(classes);
}
