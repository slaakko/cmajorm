...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConditionalCompilationPartNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ConditionalCompilationPartNode_83F63E2147A6DF491F0B9D0E960DD1D8A1868545.html" }];
    drawDiagram(classes);
}
