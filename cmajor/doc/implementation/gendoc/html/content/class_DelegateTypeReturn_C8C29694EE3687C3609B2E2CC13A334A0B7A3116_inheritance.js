...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateTypeReturn", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_DelegateTypeReturn_C8C29694EE3687C3609B2E2CC13A334A0B7A3116.html" }];
    drawDiagram(classes);
}
