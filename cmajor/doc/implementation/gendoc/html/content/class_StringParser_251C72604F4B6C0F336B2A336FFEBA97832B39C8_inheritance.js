...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::StringParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_StringParser_251C72604F4B6C0F336B2A336FFEBA97832B39C8.html" }];
    drawDiagram(classes);
}
