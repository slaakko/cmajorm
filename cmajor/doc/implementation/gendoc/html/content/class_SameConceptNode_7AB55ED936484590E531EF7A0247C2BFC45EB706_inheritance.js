...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::SameConceptNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_SameConceptNode_7AB55ED936484590E531EF7A0247C2BFC45EB706.html" }];
    drawDiagram(classes);
}
