...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::InitialPunctuationParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_InitialPunctuationParser_40284E202DB252469254FA2C6D5C405E74C33CD7.html" }];
    drawDiagram(classes);
}
