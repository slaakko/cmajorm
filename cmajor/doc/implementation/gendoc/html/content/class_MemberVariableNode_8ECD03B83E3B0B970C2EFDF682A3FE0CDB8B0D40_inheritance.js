...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::MemberVariableNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_MemberVariableNode_8ECD03B83E3B0B970C2EFDF682A3FE0CDB8B0D40.html" }];
    drawDiagram(classes);
}
