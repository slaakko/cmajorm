...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::RuleLink", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_RuleLink_4C1C4E8A50B4AD7D8A4FB592BDFE76619BF0023D.html" }];
    drawDiagram(classes);
}
