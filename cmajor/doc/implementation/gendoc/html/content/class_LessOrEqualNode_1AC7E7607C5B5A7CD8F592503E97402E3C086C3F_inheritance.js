...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::LessOrEqualNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_LessOrEqualNode_1AC7E7607C5B5A7CD8F592503E97402E3C086C3F.html" }];
    drawDiagram(classes);
}
