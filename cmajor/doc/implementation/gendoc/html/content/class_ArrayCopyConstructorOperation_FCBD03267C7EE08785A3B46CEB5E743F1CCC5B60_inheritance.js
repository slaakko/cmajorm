...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ArrayCopyConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ArrayCopyConstructorOperation_FCBD03267C7EE08785A3B46CEB5E743F1CCC5B60.html" }];
    drawDiagram(classes);
}
