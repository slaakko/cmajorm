...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DoubleValue", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_DoubleValue_B7EB5CADA34D2F74456A3F4DDB3ECDCEACAF9A4F.html" }];
    drawDiagram(classes);
}
