...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::ControlParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ControlParser_62E6C9DA41378B57BFBE7826371B59C26677CDA8.html" }];
    drawDiagram(classes);
}
