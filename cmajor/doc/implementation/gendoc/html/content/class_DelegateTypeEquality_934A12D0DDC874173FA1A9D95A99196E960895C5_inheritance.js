...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateTypeEquality", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_DelegateTypeEquality_934A12D0DDC874173FA1A9D95A99196E960895C5.html" }];
    drawDiagram(classes);
}
