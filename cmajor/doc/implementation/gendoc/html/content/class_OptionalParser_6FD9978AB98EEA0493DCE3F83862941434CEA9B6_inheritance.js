...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::OptionalParser", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_OptionalParser_6FD9978AB98EEA0493DCE3F83862941434CEA9B6.html" }];
    drawDiagram(classes);
}
