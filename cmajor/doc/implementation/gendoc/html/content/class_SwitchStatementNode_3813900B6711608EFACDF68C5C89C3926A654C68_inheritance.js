...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::SwitchStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_SwitchStatementNode_3813900B6711608EFACDF68C5C89C3926A654C68.html" }];
    drawDiagram(classes);
}
