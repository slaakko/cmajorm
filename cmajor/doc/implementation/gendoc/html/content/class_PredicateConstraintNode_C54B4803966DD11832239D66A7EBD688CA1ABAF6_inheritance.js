...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::PredicateConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_PredicateConstraintNode_C54B4803966DD11832239D66A7EBD688CA1ABAF6.html" }];
    drawDiagram(classes);
}
