...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ProjectDependencyDeclaration", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ProjectDependencyDeclaration_B22514E3F516B935BA4BF21BE78AF6563AD6124C.html" }];
    drawDiagram(classes);
}
