...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::CompoundStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_CompoundStatementNode_0696D97F97A719021BDDF41E41B940C1B5B03070.html" }];
    drawDiagram(classes);
}
