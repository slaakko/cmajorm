...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::JsonFieldNameAttributeProcessor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_JsonFieldNameAttributeProcessor_6BF51292096821F4CD25530C3EE3C84AEC5AB610.html" }];
    drawDiagram(classes);
}
