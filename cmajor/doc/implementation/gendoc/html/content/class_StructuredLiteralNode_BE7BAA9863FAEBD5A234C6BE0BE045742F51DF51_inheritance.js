...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::StructuredLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_StructuredLiteralNode_BE7BAA9863FAEBD5A234C6BE0BE045742F51DF51.html" }];
    drawDiagram(classes);
}
