...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::SymbolParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_SymbolParser_D435345C40ABD46174EEC5CB661013DBD190FF34.html" }];
    drawDiagram(classes);
}
