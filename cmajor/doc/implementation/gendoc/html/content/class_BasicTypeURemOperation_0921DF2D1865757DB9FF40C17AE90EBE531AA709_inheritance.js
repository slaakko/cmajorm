...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeURemOperation", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BasicTypeURemOperation_0921DF2D1865757DB9FF40C17AE90EBE531AA709.html" }];
    drawDiagram(classes);
}
