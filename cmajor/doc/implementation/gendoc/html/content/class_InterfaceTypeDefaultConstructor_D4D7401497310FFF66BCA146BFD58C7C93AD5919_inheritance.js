...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::InterfaceTypeDefaultConstructor", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_InterfaceTypeDefaultConstructor_D4D7401497310FFF66BCA146BFD58C7C93AD5919.html" }];
    drawDiagram(classes);
}
