...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ArrayLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ArrayLiteralNode_626CB13098008A2C46B156727CB76340707DC08B.html" }];
    drawDiagram(classes);
}
