...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ParenthesizedConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ParenthesizedConstraintNode_335F91A931F89910F6A0AFBBF1118A0C35CB68A1.html" }];
    drawDiagram(classes);
}
