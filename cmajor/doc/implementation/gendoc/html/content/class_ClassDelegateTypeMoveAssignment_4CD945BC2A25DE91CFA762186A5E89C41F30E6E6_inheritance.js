...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ClassDelegateTypeMoveAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ClassDelegateTypeMoveAssignment_4CD945BC2A25DE91CFA762186A5E89C41F30E6E6.html" }];
    drawDiagram(classes);
}
