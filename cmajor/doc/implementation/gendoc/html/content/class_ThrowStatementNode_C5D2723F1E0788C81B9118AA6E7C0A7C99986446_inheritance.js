...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ThrowStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ThrowStatementNode_C5D2723F1E0788C81B9118AA6E7C0A7C99986446.html" }];
    drawDiagram(classes);
}
