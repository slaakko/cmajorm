...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::IfStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IfStatementNode_598C07D356B27008EF7BC51C0329C91D11B53C10.html" }];
    drawDiagram(classes);
}
