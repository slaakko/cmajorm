...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::CompileUnitNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_CompileUnitNode_F6CDC04A745418A00AB314CF086C092721F42A14.html" }];
    drawDiagram(classes);
}
