...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundTemporary", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundTemporary_315499F7B13852EFEFF919C8053CF901987BEE7E.html" }];
    drawDiagram(classes);
}
