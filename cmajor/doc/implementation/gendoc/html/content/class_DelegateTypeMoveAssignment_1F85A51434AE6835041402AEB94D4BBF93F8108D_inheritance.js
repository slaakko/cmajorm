...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DelegateTypeMoveAssignment", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_DelegateTypeMoveAssignment_1F85A51434AE6835041402AEB94D4BBF93F8108D.html" }];
    drawDiagram(classes);
}
