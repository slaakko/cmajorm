...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ClassCopyAssignmentOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ClassCopyAssignmentOperation_A49E9A026C96A4D623324169AE3824B17534F5A4.html" }];
    drawDiagram(classes);
}
