...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundCompileUnit", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_BoundCompileUnit_E99BC7539B5239DF3A33DC3D613FE1D188A0A9E1.html" }];
    drawDiagram(classes);
}
