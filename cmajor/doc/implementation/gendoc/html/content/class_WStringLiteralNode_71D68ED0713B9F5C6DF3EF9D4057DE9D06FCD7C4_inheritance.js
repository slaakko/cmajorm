...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::WStringLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_WStringLiteralNode_71D68ED0713B9F5C6DF3EF9D4057DE9D06FCD7C4.html" }];
    drawDiagram(classes);
}
