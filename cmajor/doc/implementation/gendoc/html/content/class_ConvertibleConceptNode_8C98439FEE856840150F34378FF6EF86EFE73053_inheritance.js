...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConvertibleConceptNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ConvertibleConceptNode_8C98439FEE856840150F34378FF6EF86EFE73053.html" }];
    drawDiagram(classes);
}
