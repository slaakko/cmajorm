...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ComplementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ComplementNode_202BD4822EADFFCA26655B3FF8F63644B0DC6D87.html" }];
    drawDiagram(classes);
}
