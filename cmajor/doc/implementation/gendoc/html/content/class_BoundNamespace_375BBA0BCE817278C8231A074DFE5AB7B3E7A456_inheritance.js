...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundNamespace", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_BoundNamespace_375BBA0BCE817278C8231A074DFE5AB7B3E7A456.html" }];
    drawDiagram(classes);
}
