...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundEnumTypeDefinition", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_BoundEnumTypeDefinition_2895F4A41B9598387B5B5734A980C22A8B8D89AE.html" }];
    drawDiagram(classes);
}
