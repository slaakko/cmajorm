...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ImplicationNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ImplicationNode_BA3FCBA692C7C7A4BA235C32F0AB07F91ACB6266.html" }];
    drawDiagram(classes);
}
