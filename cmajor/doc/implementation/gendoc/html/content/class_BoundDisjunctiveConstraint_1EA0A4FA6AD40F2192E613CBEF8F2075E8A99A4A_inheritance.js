...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundDisjunctiveConstraint", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "class_BoundDisjunctiveConstraint_1EA0A4FA6AD40F2192E613CBEF8F2075E8A99A4A.html" }];
    drawDiagram(classes);
}
