...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::ClassMoveConstructorOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ClassMoveConstructorOperation_B57CFECB9423637BA01AB7F00A58EF6AF67CC97C.html" }];
    drawDiagram(classes);
}
