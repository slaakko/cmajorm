...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConditionalCompilationConjunctionNode", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ConditionalCompilationConjunctionNode_A04182F26D3DA23DDADCB44207882ECBDD51BD5C.html" }];
    drawDiagram(classes);
}
