...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConditionalCompilationNotNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ConditionalCompilationNotNode_693C4C8897EA5B325D39279D6A5D888810C2F515.html" }];
    drawDiagram(classes);
}
