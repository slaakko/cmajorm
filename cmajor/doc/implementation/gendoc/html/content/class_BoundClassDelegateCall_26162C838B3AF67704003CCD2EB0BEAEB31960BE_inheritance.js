...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundClassDelegateCall", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundClassDelegateCall_26162C838B3AF67704003CCD2EB0BEAEB31960BE.html" }];
    drawDiagram(classes);
}
