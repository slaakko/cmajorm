...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::BitXorNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_BitXorNode_0B30020E3526A78441B4855EA9CCC3D14692CCC7.html" }];
    drawDiagram(classes);
}
