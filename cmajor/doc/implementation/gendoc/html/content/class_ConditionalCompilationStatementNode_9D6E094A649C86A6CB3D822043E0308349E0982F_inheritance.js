...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::StatementNode", id: "class_1", level: 1, subject: false, hasDerivedClasses: true, link: "class_StatementNode_5B30CD05CFBD6FC4DC65F9EB63116552354DEF08.html" },
        { name: "cmajor::ast::ConditionalCompilationStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ConditionalCompilationStatementNode_9D6E094A649C86A6CB3D822043E0308349E0982F.html" }];
    drawDiagram(classes);
}
