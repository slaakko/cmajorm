...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsCharTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsCharTypePredicate_15A4CD0A80985E7CC9010055CA26AE8634DE7CA9.html" }];
    drawDiagram(classes);
}
