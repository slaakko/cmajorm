...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ParameterNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ParameterNode_6A092C19F0E267DB1C50EC127B93CFC3BD91B2A2.html" }];
    drawDiagram(classes);
}
