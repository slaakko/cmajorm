...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::PointerReturnOperation", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_PointerReturnOperation_FEE048B2BC3D229404AE1074E1B0EE634EA8DDF4.html" }];
    drawDiagram(classes);
}
