...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::BasicTypeExplicitZeroExtensionOperation", id: "class_5", level: 5, subject: true, hasDerivedClasses: false, link: "class_BasicTypeExplicitZeroExtensionOperation_FFA60278AFF0B2E5400F3FB17CA93830CA3EEDE6.html" }];
    drawDiagram(classes);
}
