...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayLengthIntrinsicFunction", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "class_ArrayLengthIntrinsicFunction_A1E4D5E91532F119586067C2BE74AE00AD15BC81.html" }];
    drawDiagram(classes);
}
