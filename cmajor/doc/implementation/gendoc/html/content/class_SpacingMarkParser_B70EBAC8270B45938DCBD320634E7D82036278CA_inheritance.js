...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::SpacingMarkParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_SpacingMarkParser_B70EBAC8270B45938DCBD320634E7D82036278CA.html" }];
    drawDiagram(classes);
}
