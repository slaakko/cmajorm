...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::OtherNumberParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_OtherNumberParser_7B8F1B90C801B86B7418BDBC84901F557716C053.html" }];
    drawDiagram(classes);
}
