...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsIntegralTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsIntegralTypePredicate_84606C2CEFB2A11687C861516F9B861EE44EE98F.html" }];
    drawDiagram(classes);
}
