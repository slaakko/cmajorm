...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::AssignmentStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_AssignmentStatementNode_EEC3DC79A1FC1DA85D237B860CE62B6392E5B0CB.html" }];
    drawDiagram(classes);
}
