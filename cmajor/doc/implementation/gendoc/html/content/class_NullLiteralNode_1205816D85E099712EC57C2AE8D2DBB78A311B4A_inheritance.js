...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::NullLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_NullLiteralNode_1205816D85E099712EC57C2AE8D2DBB78A311B4A.html" }];
    drawDiagram(classes);
}
