...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::BaseCharParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_BaseCharParser_43995E8BEB3EEB0EBF60EF639DB2E655C29AED48.html" }];
    drawDiagram(classes);
}
