...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::TemplateParameterSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_TemplateParameterSymbol_E40C8C6A1A16CD38F979FFEC21EFECE32E4417BC.html" }];
    drawDiagram(classes);
}
