...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::DestructorSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_DestructorSymbol_6626180D5ED2C1B180810259C5E3AB2C9CC4E182.html" }];
    drawDiagram(classes);
}
