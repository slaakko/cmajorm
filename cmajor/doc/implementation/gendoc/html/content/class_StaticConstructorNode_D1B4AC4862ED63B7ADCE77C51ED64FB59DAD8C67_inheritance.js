...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::StaticConstructorNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_StaticConstructorNode_D1B4AC4862ED63B7ADCE77C51ED64FB59DAD8C67.html" }];
    drawDiagram(classes);
}
