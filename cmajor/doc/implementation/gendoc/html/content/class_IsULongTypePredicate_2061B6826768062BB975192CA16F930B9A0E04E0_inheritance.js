...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::IsULongTypePredicate", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsULongTypePredicate_2061B6826768062BB975192CA16F930B9A0E04E0.html" }];
    drawDiagram(classes);
}
