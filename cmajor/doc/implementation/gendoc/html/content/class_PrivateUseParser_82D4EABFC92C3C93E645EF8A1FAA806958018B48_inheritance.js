...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::PrivateUseParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_PrivateUseParser_82D4EABFC92C3C93E645EF8A1FAA806958018B48.html" }];
    drawDiagram(classes);
}
