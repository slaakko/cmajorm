...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ArrayCBeginFunction", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ArrayCBeginFunction_DB986604D76D5F669E06DF1930205AD914519F6A.html" }];
    drawDiagram(classes);
}
