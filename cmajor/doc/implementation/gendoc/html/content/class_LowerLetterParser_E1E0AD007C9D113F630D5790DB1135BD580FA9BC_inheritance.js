...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::parsing::LowerLetterParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_LowerLetterParser_E1E0AD007C9D113F630D5790DB1135BD580FA9BC.html" }];
    drawDiagram(classes);
}
