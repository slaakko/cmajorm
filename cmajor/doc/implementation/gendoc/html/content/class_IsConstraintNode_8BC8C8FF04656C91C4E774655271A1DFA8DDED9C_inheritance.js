...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::IsConstraintNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_IsConstraintNode_8BC8C8FF04656C91C4E774655271A1DFA8DDED9C.html" }];
    drawDiagram(classes);
}
