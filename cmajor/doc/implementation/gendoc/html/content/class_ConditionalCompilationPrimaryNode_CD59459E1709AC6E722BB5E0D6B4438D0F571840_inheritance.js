...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::ast::ConditionalCompilationPrimaryNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "class_ConditionalCompilationPrimaryNode_CD59459E1709AC6E722BB5E0D6B4438D0F571840.html" }];
    drawDiagram(classes);
}
