...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundAddressOfExpression", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundAddressOfExpression_A5E64A329637AA93D0A30E7D1814C2EEE18E77AC.html" }];
    drawDiagram(classes);
}
