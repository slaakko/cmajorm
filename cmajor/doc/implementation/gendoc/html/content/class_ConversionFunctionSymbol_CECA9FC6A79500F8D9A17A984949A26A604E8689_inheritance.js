...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::symbols::ConversionFunctionSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_ConversionFunctionSymbol_CECA9FC6A79500F8D9A17A984949A26A604E8689.html" }];
    drawDiagram(classes);
}
