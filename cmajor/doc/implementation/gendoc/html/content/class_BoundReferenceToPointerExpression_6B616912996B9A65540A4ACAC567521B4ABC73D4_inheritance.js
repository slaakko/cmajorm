...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "cmajor::binder::BoundReferenceToPointerExpression", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "class_BoundReferenceToPointerExpression_6B616912996B9A65540A4ACAC567521B4ABC73D4.html" }];
    drawDiagram(classes);
}
