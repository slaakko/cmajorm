...
Identifier::Identifier(cmajor::parsing::ParsingDomain* parsingDomain_): cmajor::parsing::Grammar(ToUtf32("Identifier"), parsingDomain_->GetNamespaceScope(ToUtf32("cmajor.code")), parsingDomain_)
{
    SetOwner(0);
}
...
void Identifier::GetReferencedGrammars()
{
    ...
    cmajor::parsing::Grammar* grammar1 = pd->GetGrammar(ToUtf32("cmajor.code.Keyword"));
    if (!grammar1)
    {
        grammar1 = cmajor::code::Keyword::Create(pd);
    }
