...
soulng::parser::Match NothrowSpecifierParser::Specifiers(CmajorNothrowLexer& lexer)
{
                ...
                while (true)
                {
                    int64_t save = lexer.GetPos();
                    {
                        ...
                        soulng::parser::Match* parentMatch3 = &match;
                        {
                            ...
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::parser::Match match = NothrowSpecifierParser::Specifier(lexer);
...
soulng::parser::Match NothrowSpecifierParser::Specifier(CmajorNothrowLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
