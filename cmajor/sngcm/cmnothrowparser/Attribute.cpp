...
soulng::parser::Match NothrowAttributeParser::Attributes(CmajorNothrowLexer& lexer, boost::uuids::uuid* moduleId)
{
            ...
            soulng::parser::Match* parentMatch3 = &match;
            {
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        {
                            soulng::parser::Match match = NothrowAttributeParser::Attribute(lexer, attributes.get(), moduleId);
                            *parentMatch6 = match;
                        }
                        if (match.hit)
                        {
