...
soulng::parser::Match NothrowGlobalVariableParser::GlobalVariable(CmajorNothrowLexer& lexer, boost::uuids::uuid* moduleId, NothrowParsingContext* ctx, sngcm::ast::CompileUnitNode* cu)
{
