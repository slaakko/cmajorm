...
void ParseParserFileLine(const std::u32string& parserFileLine, sngcm::ast::SourceTokenFormatter* formatter, bool& inBlockComment)
{
    using namespace ParserFileTokenLexerTokens;
    using namespace soulng::unicode;

    std::u32string line(parserFileLine);
    line.append(U"\n");
