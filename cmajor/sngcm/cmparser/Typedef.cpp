...
// this file has been automatically generated from 'C:/work/cmajorm/cmajor/sngcm/cmparser/Typedef.parser' using soulng parser generator spg version 3.0.0

using namespace soulng::unicode;
using namespace sngcm::ast;
using namespace CmajorTokens;

soulng::parser::Match TypedefParser::Typedef(CmajorLexer& lexer, boost::uuids::uuid* moduleId, ParsingContext* ctx)
{
            ...
            soulng::parser::Match* parentMatch11 = &match;
            {
                ...
                if (match.hit)
                {
                    s.end = span.end;
                    {
                        ...
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
                        return soulng::parser::Match(true, new TypedefNode(s, *moduleId, specifiers->value, type.release(), id.release()));
                    }
                }
                *parentMatch11 = match;
            }
