...
#include <sngcm/cmnothrowlexer/CmajorNothrowClassMap.hpp>

using namespace soulng::lexer;
using namespace CmajorNothrowTokens;

CmajorNothrowLexer::CmajorNothrowLexer(const std::u32string& content_, const std::string& fileName_, int fileIndex_) : soulng::lexer::Lexer(content_, fileName_, fileIndex_),
...
{
    SetKeywordMap(CmajorNothrowKeywords::GetKeywordMap());
}

CmajorNothrowLexer::CmajorNothrowLexer(const char32_t* start_, const char32_t* end_, const std::string& fileName_, int fileIndex_) : soulng::lexer::Lexer(start_, end_, fileName_, fileIndex_),
    floatingLit(), floatingLitFloat(), intLit(), intLitUnsigned(), chrLit(), chrLitPrefix(), strLit(), strLitPrefix(), leftAngleCount(), parsingOperatorFunctionGroupId()
{
    SetKeywordMap(CmajorNothrowKeywords::GetKeywordMap());
}

int CmajorNothrowLexer::NextState(int state, char32_t c)
{
    int i = CmajorNothrowClassMap::GetClass(c);
    switch (state)
    {
        case 0:
        {
...
int CmajorNothrowLexer::GetTokenId(int statementIndex)
{
