#ifndef CmajorNothrowTokens_HPP
#define CmajorNothrowTokens_HPP
...
namespace CmajorNothrowTokens
{
    ...
    SNGCM_NOTHROW_LEXER_API void InitTokenIdMap();
    SNGCM_NOTHROW_LEXER_API int GetTokenId(const std::u32string& tokenName);
    SNGCM_NOTHROW_LEXER_API const char* GetTokenName(int tokenId);
    SNGCM_NOTHROW_LEXER_API const char* GetTokenInfo(int tokenId);
}
#endif
