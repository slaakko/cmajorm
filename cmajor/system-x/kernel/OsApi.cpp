        ...
        if (numRead > 0)
        {
            ...
            if (inputRecord->EventType == KEY_EVENT)
            {
                ...
                if (keyEventRecord->bKeyDown)
                {
                    ...
                    case VK_F1: if (ctrl) ch = static_cast<char32_t>(keyControlF1); else ch = static_cast<char32_t>(keyF1); break;
                    case VK_F2: if (ctrl) ch = static_cast<char32_t>(keyControlF2); else ch = static_cast<char32_t>(keyF2); break;
                    case VK_F3: if (ctrl) ch = static_cast<char32_t>(keyControlF3); else ch = static_cast<char32_t>(keyF3); break;
                    case VK_F4: if (ctrl) ch = static_cast<char32_t>(keyControlF4); else ch = static_cast<char32_t>(keyF4); break;
                    case VK_F5: if (ctrl) ch = static_cast<char32_t>(keyControlF5); else ch = static_cast<char32_t>(keyF5); break;
                    case VK_F6: if (ctrl) ch = static_cast<char32_t>(keyControlF6); else ch = static_cast<char32_t>(keyF6); break;
                    case VK_F7: if (ctrl) ch = static_cast<char32_t>(keyControlF7); else ch = static_cast<char32_t>(keyF7); break;
                    case VK_F8: if (ctrl) ch = static_cast<char32_t>(keyControlF8); else ch = static_cast<char32_t>(keyF8); break;
                    case VK_F9: if (ctrl) ch = static_cast<char32_t>(keyControlF9); else ch = static_cast<char32_t>(keyF9); break;
                    case VK_F10: if (ctrl) ch = static_cast<char32_t>(keyControlF10); else ch = static_cast<char32_t>(keyF10); break;
                    case VK_F11: if (ctrl) ch = static_cast<char32_t>(keyControlF11); else ch = static_cast<char32_t>(keyF11); break;
                    case VK_F12: if (ctrl) ch = static_cast<char32_t>(keyControlF12); else ch = static_cast<char32_t>(keyF12); break;
                    }
                    if (ch == '\0' && ctrl)
                    {
                        switch (keyEventRecord->wVirtualKeyCode)
