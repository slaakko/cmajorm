...
void LinuxCodeGenerator::Visit(BoundTryStatement& boundTryStatement)
{
    ...
    void* exPtrAlloca = emitter->NewAllocaInst(emitter->GetIrTypeForVoidPtrType(), EntryBasicBlock());
    ...
    void* exIdAlloca = emitter->NewAllocaInst(emitter->GetIrTypeForInt(), EntryBasicBlock());
