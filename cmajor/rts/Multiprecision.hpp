...
extern "C" RT_API RT_API void* RtCreateDefaultBigInt(int32_t& errorStrHandle);
extern "C" RT_API RT_API void* RtCreateBigIntFromInt(int32_t v, int32_t& errorStrHandle);
