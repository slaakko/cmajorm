...
namespace cmajor
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Console App", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "cmproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "Cmajor";

        internal const string Language = "Cmajor";
